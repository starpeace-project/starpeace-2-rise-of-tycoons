        ...
        case IllSystem.UseSkill(Artificer.SkillVal, Diff) of
          ...
          3:
            begin
              ...
              healthHurt := IllSystem.CriminalWounded(Artificer.Name, 2);
              case healthHurt of
                    0: rep := 'kill himself';
             ...
             Report.Values['OpenVaultExpl'] := Artificer.Name + ' executed a bad explosion. Big damage to the content of the safe, and he managed to ' + rep;
             NextDiff := 70;
             AfterInTheBank := 'DrivingAway';
          ...
          4:
            begin
              healthHurt := IllSystem.CriminalWounded(Artificer.Name, 3);
              case healthHurt of
                    0: rep := 'kill himself';
                    1..20: rep := 'hurt himself really badly';
                    21..50: rep := 'hurt himself badly';
             ...
             Report.Values['OpenVaultExpl'] := Artificer.Name + ' executed a disastrous explosion. The whole content of the safe is destroyed, and he managed to ' + rep;
             NextDiff := 80;
             AfterInTheBank := 'DrivingAway';
             Profit := Profit + 0;
              {IllSystem.RDOChangeCriminalState(Artificer.Name, 'InTeam: InMission: Dead');
