...
interface
   uses MapTypes, VisualClassManager,BuildClasses,classes,sysutils, Graphics;


   function loadclass : integer;
   function  ParseSoundData(const str : string) : TSoundData;
   function getbuildinginfo(vclass:integer) : PBuildingClass;
...
implementation
  ...
  function getbuildinginfo(vclass:integer) : PBuildingClass;
    var
      //bsinfo1  : PBuildingClass;
      i : integer;
    begin     //  
      if not loaded1  then i:= loadclass;
      result:= fBuildingClasses.Get(vclass);
