...
uses
  ...
  InternationalizerComponent, Config, Privacy, ImgList, music1;
...
procedure TOptionsHandlerView.Timer1Timer(Sender: TObject);
begin
   // start stuff here
   prog.Position := round((music1.Form2.mplay.Position / music1.Form2.mplay.Length)*100);
   //tl1.Caption:= inttostr(music1.Form2.mplay.Position) + '/' + inttostr(music1.Form2.mplay.Length);
   if music1.Form2.mplay.Position >= music1.Form2.mplay.Length then
    begin
         //

         fPlayListInt.SelectNextFile;
         music1.Form2.SetMPVolume(music1.Form2.mplay,(musicVol.Value*10));
    end;
