...
interface
  ...
  uses
    ...
    FiveTypes, MapIsoView, Config, ExtCtrls, VCLUtils,topinfobar;
              ...
              evnKeyCommand :
                case KeyCommand of
                  keyCmdESC :
                    ...
                    keytoptoolbar :
                    if topinfobar.tib.Panel1.Visible = true then
                      begin
                        topinfobar.tib.Panel1.Visible:=false;
                        topinfobar.tib.Panel2.Visible:=true;
                        topinfobar.tib.Height:=topinfobar.tib.Height -13;
                        topinfobar.tbshow:=7;
                      end
                    else
                      begin
                        topinfobar.tib.Panel1.Visible :=true;
