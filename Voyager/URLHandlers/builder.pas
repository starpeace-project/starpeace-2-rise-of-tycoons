...
{$R *.dfm}
  procedure Tbuilder.Panel4Resize(Sender: TObject);
begin
 // test
 ...
 //scrollbox1.VertScrollBar.Visible:=false;     500
 scrollbox1.VertScrollBar.Visible:=true;
 scrollbox1.VertScrollBar.Range:=scrollbox1.ClientHeight*2 ;  //
 scrollbox1.VertScrollBar.Increment:=50;
 //scrollbox1.AutoScroll:=true;
           ScrollBox1.Align:=altop;
        ...
        begin  //list buildings
           ...
           for j := 0 to strtoint(buildfaclist.Values['listcount']) - 1 do
             begin
               ...
               m1.panel1.height:= 20;
               m1.Height:=20;
               //logs.Log('buildmenu','np - 5 ' + buildfaclist.Values['name' + inttostr(j)]);
               ...
               //logs.Log('buildmenu','np - 5.2 ' + bsinfo2.ImagePath );
               ...
               //test
              { if j=strtoint(buildfaclist.Values['listcount']) - 2 then
                begin
                  // force click of m1
                  m1.bname.Perform(WM_LBUTTONDOWN, 0, 0);
                  m1.bname.Perform(WM_LBUTTONUP, 0, 0);
                end;    }
               //last rename frame
           ...
           panelb1.Height:= strtoint(buildfaclist.Values['listcount'])*20;
           panelb1.Align:=altop;
           panelb1.Top:=0;
           panelb1.Left:=0;
           panelb1.OnResize:=Panel4Resize;
           //panelb1.Width:=209;
