...
implementation
  ...
  constructor TToolbarHandler.Create( aNestedMetaHandler, aAdsHandler : IMetaURLHandler );
    begin
      inherited Create;                                              
      fNestedHandler := aNestedMetaHandler.Instantiate;      //remove
  ...
  function TToolbarHandler.HandleURL( URL : TURL ) : TURLHandlingResult;
    begin
      //result := fNestedHandler.HandleURL( URL );     //change this section
      result := urlNotHandled;
      if fClientView.getCompanyId = 0 then
        begin
          // visitor visa
          fcontrol.bbuild.Visible := false;
          fcontrol.bfav.Visible := false;
          fcontrol.bprofile.Visible := false;
        end
      else
        begin
          //
          fcontrol.bbuild.Visible := true;
          fcontrol.bfav.Visible := true;
          fcontrol.bprofile.Visible := true;
        end;  
    end;
  ...
  //                Money.Caption := auxStr;
        ...
        evnHandlerExposed :
          begin
            ...
            fNestedHandler.getControl.Parent := fControl.Container2;
            {
            ...
            fControl.BusyClipPath := 'cache\OtherImages\busy.gif';   //CachePath + 'OtherImages\busy.gif';
