...
uses
  ...
  InternationalizerComponent,variants;
...
const
  {$IFNDEF BETA}
  APPNAME     = 'Starpeace 2';
  VoyagerKey  = '\Software\pugland\Starpeace\Client\System\';
  VoyagerMode = 'NORMAL';
  {$ELSE}
  APPNAME        = 'Starpeace 2';
  VoyagerKey     = '\Software\pugland\StarpeaceTest\Client\System\';
  PrevVoyagerKey = '\Software\pugland\Starpeace\Client\System\';
  VoyagerMode    = 'TEST';
  {$ENDIF}
  ...
  function TUpdateFrm.GetSource : string;
    ...
    function GetSourceFromIniFile : string;
      ...
      begin
        ...
        fDSAddr := 'starpeace.co.cc'; //IniFile.ReadString( 'Directory', 'DSAddr', 'dir.legacyonline.net' );
        fDSPort := 1111; //IniFile.ReadInteger( 'Directory', 'DSPort', 1111 );
        try
    ...
    const
      EmbededDefaultSite = 'http://www.starpeace.co.cc/five/';
    var
      Reg : TRegistry;
    begin
      try
...
procedure TUpdateFrm.FramedButton5Click(Sender: TObject);
begin
close;
end;
