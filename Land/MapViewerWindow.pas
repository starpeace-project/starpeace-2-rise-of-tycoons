...
implementation
  ...
  procedure TLandViewerWin.FormCreate(Sender: TObject);
    ...
    begin
      ...
      //if OpenClasses.Execute and (OpenClasses.FileName <> '')     OpenClasses.FileName
      //  then
      //    begin
            fLandRenderer := TLandRenderer.Create( ExtractFilePath('C:\Program Files\Starpeace\Cache\LandClasses\land.0.ini') );
