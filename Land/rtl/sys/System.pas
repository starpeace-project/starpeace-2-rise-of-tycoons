...
{ System Unit                                                             }
{                                                                         }
{ Copyright (c) 1988-2005 Borland Software Corporation                    }
{                                                                         }
...
function _NewAnsiString(length: Longint): Pointer;      { for debugger & some RTL usage }
...
function CompareString(Locale: Integer; dwCmpFlags: Integer; lpString1: PChar;
  cchCount1: Integer; lpString2: PChar; cchCount2: Integer): Integer; stdcall;
  external kernel name 'CompareStringA';
...
{$ENDIF}
{$IFDEF MSWINDOWS}
  Result := WideCharToMultiByte(DefaultSystemCodePage, 0, WCharSource, SrcChars,
