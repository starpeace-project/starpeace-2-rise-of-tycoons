...
implementation
  ...
  constructor TMetalimestoneBlock.Create(anId            : string;
                                    aCapacities     : array of TFluidValue;
                                    aLegalServMax   : TFluidValue;
                                    aCompMax        : TFluidValue;
                                    aChemicalMax    : TFluidValue;
    ...
    begin
      ...
      MetaOutputs.Insert(
        TMetaOutput.Create(
          ...
          TPullOutput,
          TMetaFluid(TheClassStorage.ClassById[tidClassFamily_Fluids, tidFluid_limestone]),
          5,
          [mgoptCacheable, mgoptEditable],
      ...
      with TMetaOutputEvaluator.Create(
        ...
        OutputByName[tidGate_limestone],
        TOutputEvaluator) do
        begin
          FullOpenTime  := 30;
          FullCloseTime := 31;
  ...
  procedure RegisterBackup;
    begin
      BackupInterfaces.RegisterClass(TlimestoneBlock);
    end;
