...
implementation
  ...
  constructor TMetaalmineBlock.Create(anId            : string;
                                    aCapacities     : array of TFluidValue;
                                    aLegalServMax   : TFluidValue;
                                    aCompMax        : TFluidValue;
                                    aChemicalMax    : TFluidValue;
    ...
    begin
      ...
      MetaOutputs.Insert(
        TMetaOutput.Create(
          ...
          TPullOutput,
          TMetaFluid(TheClassStorage.ClassById[tidClassFamily_Fluids, tidFluid_alore]),
          5,
          [mgoptCacheable, mgoptEditable],
  ...
  procedure RegisterBackup;
    begin
      BackupInterfaces.RegisterClass(TalmineBlock);
    end;
