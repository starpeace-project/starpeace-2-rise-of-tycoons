...
interface
  ...
  uses
    ...
    Accounts, StdFluids, Languages, CacheAgent, Inventions,variants,logs;
    ...
    begin
      ...
      for i := 0 to pred(MetaBlock.Inventions.Count) do
        begin
          ...
          if Invention.Quality2 > 0 then
            MaxQuality := MaxQuality + Invention.Quality2
          else
            MinQuality := MinQuality + Invention.Quality2;
          if Facility.Company.HasInvention[Invention.NumId]
            then
              begin
               // invEfficiency := invEfficiency + Invention.Effic2;
               //invQuality    := invQuality + Invention.Quality2;
                ...
                if (Invention.Quality2<65) and (Invention.Quality2>-65) then invQuality := invQuality + b else invQuality := invQuality + a;
                ...
                if (Invention.Effic2<65) and (Invention.Effic2>-65)then invEfficiency  := invEfficiency  + d else invEfficiency  := invEfficiency  + c;
                x:= invention.Name + ' ' +inttostr(invention.Effic) + ' ' +inttostr(invention.Quality) + ' ~ ' +inttostr(invention.Effic2) + ' ' +inttostr(invention.Quality2)+ ' # ' + inttostr(invQuality) + ' ' + inttostr(invEfficiency);
