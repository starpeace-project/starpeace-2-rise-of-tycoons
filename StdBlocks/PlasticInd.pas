...
interface
  ...
  const
    {$ifdef newpack}
    bidGate_Chemicals = tidGate_organicchems;
    bidFluid_Chemicals = tidFluid_organicchems;
   {$ELSE}
    ...
    begin
      ...
      MetaInputs.Insert(
        TMetaInput.Create(
          ...
          qIlimited,
          TPullInput,
          TMetaFluid(TheClassStorage.ClassById[tidClassFamily_Fluids, bidGate_Chemicals]),
          5,
          mglBasic,
          [mgoptCacheable, mgoptEditable],
