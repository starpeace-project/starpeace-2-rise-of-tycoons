...
interface
  ...
  type
   ...
   const
    toasterAveragePrice = 47;
    tidService_toaster = 'toaster';
    microwaveAveragePrice = 125;
    tidService_microwave = 'microwave';
    tidService_cooker = tidFluid_cooker;
    tidService_kettle = 'kettle';
    kettleAveragePrice = 27;
...
implementation
  ...
  constructor TMetaMallhha1Block.Create(anId          : string;
                                         aCapacities   : array of TFluidValue;
                                         aCompMax      : TFluidValue;
                                         aLegalServMax : TFluidValue;
                                         aFreshFoodMax : TFluidValue;
    ...
    begin
      ...
      // Services
      FreshFoodService := TMetaService(TheClassStorage.ClassById[tidClassFamily_Services, tidService_cooker]);
      ElabFoodService  := TMetaService(TheClassStorage.ClassById[tidClassFamily_Services, tidService_toaster]);
      ClothesService   := TMetaService(TheClassStorage.ClassById[tidClassFamily_Services, tidService_kettle]);
      HHAService       := TMetaService(TheClassStorage.ClassById[tidClassFamily_Services, tidService_microwave]);
  ...
  procedure RegisterBackup;
    begin
      BackupInterfaces.RegisterClass(TMallhha1Block);
    end;
