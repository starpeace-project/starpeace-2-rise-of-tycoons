...
implementation
  ...
  constructor TMetaceramicMineBlock.Create(anId            : string;
                                           aCapacities     : array of TFluidValue;
                                           aLegalServMax   : TFluidValue;
                                           aCompMax        : TFluidValue;
                                           aChemicalMax    : TFluidValue;
    ...
    begin
      ...
      with TMetaOutputEvaluator.Create(
        ...
        OutputByName[tidGate_ceramicore],
        TOutputEvaluator) do
        begin
          FullOpenTime  := 30;
          FullCloseTime := 31;
  ...
  procedure RegisterBackup;
    begin
      BackupInterfaces.RegisterClass(TceramicMineBlock);
    end;
