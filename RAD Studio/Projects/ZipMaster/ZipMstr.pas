...
(*
  ...
  Name hashing idea by Bernd Heinemann
...
const
  ...
  ZIPMASTERBUILD: String =  '1.79.10.16';
  ZIPMASTERVER: Integer = 179;
  ZIPMASTERPRIV: Integer =  1791016;
  DELZIPVERSION = 179;                     
...
//  begin
//{$IFDEF USE_HASH}
//    Result := TZMWorker(fZip).DirHashs.Find(Name);
//{$ELSE}
//    idx := -1;
//    Result := Find(Name, idx);
//{$ENDIF}
//  end
//  else
//    Result := Nil;
