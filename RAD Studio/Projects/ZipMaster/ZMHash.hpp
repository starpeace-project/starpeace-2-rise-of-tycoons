...
// (DO NOT EDIT: machine generated header) 'Zmhash.pas' rev: 11.00
...
public:
	__fastcall TZipDirHashList(unsigned ReqSize);
...
//-- var, const, procedure ---------------------------------------------------
static const Word HDEBlockEntries = 0x200;
