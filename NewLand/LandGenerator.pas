...
interface
  ...
  uses
    newLand, Classes, Collection, Windows, Graphics;
                ...
                while (j < 3) and matches do
                  begin
                    ...
                    matches :=
                      ...
                      (Check = chkCenter) and (newLand.LandPrimaryClassOf( LandId ) = fCenterClass) or
                      (Check = chkBorder) and (newLand.LandPrimaryClassOf( LandId ) = fBorderClass);
                    inc( j );
                  end;
                inc( i );
              end;
      ...
      begin
        ...
        while found do
          begin
            ...
            LandPClass  := newLand.LandPrimaryClassOf( VisualClass.LandVisualClassId );
            LandSClass  := newLand.LandSecondaryClassOf( VisualClass.LandVisualClassId );
            LandType    := newLand.LandTypeOf( VisualClass.LandVisualClassId );
    ...
    function LandValueOfColor( Color : TColor ) : TLandVisualClassId;
      ...
      begin
        ...
        while (LandClass <= high(LandClass)) and (fColors[LandClass] <> Color) do
          inc( LandClass );
        result := newLand.PrimaryLandClassIds[LandClass];
      end;
