...
interface
  ...
  const
    tidBlock_MoabelFarmConstr = 'MoabelFarmConstr';
    tidBlock_MoabelFarm       = 'MoabelFarm';
    tidFacility_MoabelFarm    = 'MoabelFarm';
    vidFacility_MoabelFarm    = 40001;
    
  const
    tidBlock_MoabMassiveFarmConstr = 'MoabMassiveFarmConstr';
    tidBlock_MoabMassiveFarm       = 'MoabMassiveFarm';
    tidFacility_MoabMassiveFarm    = 'MoabMassiveFarm';
    vidFacility_MoabMassiveFarm    = 40005;
  ...
  const
    tidBlock_MoabfruitpieConstr = 'MoabfruitpieConstr';
    tidBlock_Moabfruitpie       = 'Moabfruitpie';
    tidFacility_Moabfruitpie    = 'Moabfruitpie';
    vidFacility_Moabfruitpie    = 10055;

  const
    tidBlock_MoabfruitFarmaConstr = 'moabfruitFarmaSmallConstr';
    tidBlock_moabfruitFarma       = 'moabfruitFarmaSmall';
    tidFacility_moabfruitFarma    = 'moabfruitFarmaSmall';
    vidFacility_moabfruitFarma    = 10048;

  const
    tidBlock_MoabrubbersapConstr = 'moabrubbersapSmallConstr';
    tidBlock_moabrubbersap       = 'moabrubbersapSmall';
    tidFacility_moabrubbersap    = 'moabrubbersapSmall';
    vidFacility_moabrubbersap    = 10059;
  const
    tidBlock_MoabrubbertreeConstr = 'moabrubbertreeConstr';
    tidBlock_moabrubbertree       = 'moabrubbertree';
    tidFacility_moabrubbertree    = 'moabrubbertree';
    vidFacility_moabrubbertree    = 19051;
  const
    tidBlock_MoabrubberfactConstr = 'moabrubberfactConstr';
    tidBlock_moabrubberfact       = 'moabrubberfact';
    tidFacility_moabrubberfact    = 'moabrubberfact';
    vidFacility_moabrubberfact    = 10062;
  const
    tidBlock_MoabshoefactConstr = 'moabshoefactConstr';
    tidBlock_moabshoefact       = 'moabshoefact';
    tidFacility_moabshoefact    = 'moabshoefact';
    vidFacility_moabshoefact    = 10065;
  const
    tidBlock_MoabpieshopConstr = 'moabpieshopConstr';
    tidBlock_moabpieshop       = 'moabpieshop';
    tidFacility_moabpieshop    = 'moabpieshop';
    vidFacility_moabpieshop    = 10068;
  const
    tidBlock_MoabshoeshopConstr = 'moabshoeshopConstr';
    tidBlock_moabshoeshop       = 'moabshoeshop';
    tidFacility_moabshoeshop    = 'moabshoeshop';
    vidFacility_moabshoeshop    = 10071;
  const
    tidBlock_MoabengineConstr = 'moabengineConstr';
    tidBlock_moabengine       = 'moabengine';
    tidFacility_moabengine    = 'moabengine';
    vidFacility_moabengine    = 10286;
  const
    tidBlock_MoabtireConstr = 'moabtireConstr';
    tidBlock_moabtire       = 'moabtire';
    tidFacility_moabtire    = 'moabtire';
    vidFacility_moabtire    = 10289;
  const
    tidBlock_MoabhumveeConstr = 'moabhumveeConstr';
    tidBlock_moabhumvee       = 'moabhumvee';
    tidFacility_moabhumvee    = 'moabhumvee';
    vidFacility_moabhumvee    = 10292;
  const
    tidBlock_MoabcookerConstr = 'moabcookerConstr';
    tidBlock_moabcooker       = 'moabcooker';
    tidFacility_moabcooker    = 'moabcooker';
    vidFacility_moabcooker    = 10295;
  const
    tidBlock_MoabhumveestoreConstr = 'moabhumveestoreConstr';
    tidBlock_moabhumveestore       = 'moabhumveestore';
    tidFacility_moabhumveestore    = 'moabhumveestore';
    vidFacility_moabhumveestore    = 10298;
  const
    tidBlock_MoabcookerStoreConstr = 'moabcookerStoreConstr';
    tidBlock_moabcookerStore       = 'moabcookerStore';
    tidFacility_moabcookerStore    = 'moabcookerStore';
    vidFacility_moabcookerStore    = 10301;
  const
    tidBlock_MoabgypsumConstr = 'moabgypsumConstr';
    tidBlock_moabgypsum       = 'moabgypsum';
    tidFacility_moabgypsum    = 'moabgypsum';
    vidFacility_moabgypsum    = 10331;
  const
    tidBlock_MoablimestoneConstr = 'moablimestoneConstr';
    tidBlock_moablimestone       = 'moablimestone';
    tidFacility_moablimestone    = 'moablimestone';
    vidFacility_moablimestone    = 10335;
  const
    tidBlock_MoabgravelConstr = 'moabgravelConstr';
    tidBlock_moabgravel       = 'moabgravel';
    tidFacility_moabgravel    = 'moabgravel';
    vidFacility_moabgravel    = 10339;
  const
    tidBlock_Moabconst2Constr = 'moabconst2Constr';
    tidBlock_moabconst2       = 'moabconst2';
    tidFacility_moabconst2    = 'moabconst2';
    vidFacility_moabconst2    = 10346;
  const
    tidBlock_MoabcontrolsysConstr = 'moabcontrolsysConstr';
    tidBlock_moabcontrolsys       = 'moabcontrolsys';
    tidFacility_moabcontrolsys    = 'moabcontrolsys';
    vidFacility_moabcontrolsys    = 10349;
  const
    tidBlock_MoabnetworksysConstr = 'moabnetworksysConstr';
    tidBlock_moabnetworksys       = 'moabnetworksys';
    tidFacility_moabnetworksys    = 'moabnetworksys';
    vidFacility_moabnetworksys    = 10343;
