...
interface
  ...
  const
   ...
   const
    tidBlock_MagnaMovieAConstr = 'MagnaMovieAConstr';
    tidBlock_MagnaMovieA       = 'MagnaMovieA';
    tidFacility_MagnaMovieA    = 'MagnaMovieA';
    vidFacility_MagnaMovieA    = 50009;

   //office
   const
    tidBlock_moff1Constr = 'Magnaoff1Constr';
    tidBlock_moff1       = 'Magnamoff1';
    tidFacility_moff1    = 'Magnamoff1';
    vidFacility_moff1    = 50002;
