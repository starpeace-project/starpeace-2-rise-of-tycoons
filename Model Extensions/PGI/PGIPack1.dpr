...
uses
  ...
  DirectoryServerProtocol in '..\..\DServer\DirectoryServerProtocol.pas'{$ifdef oldbuild},
  ...
  PrintingPlant in '..\..\StdBlocks\PrintingPlant.pas'{$endif}{$IFDEF newpack},
  ...
  servers in '..\..\StdBlocks\servers.pas'{$ENDIF};
...
procedure RegisterIndustries;
  begin
    ...
    with TMetaFacility.Create( tidFacility_PGIelFarm, 'Large Farm', vidFacility_PGIelFarm, TFacility ) do
      begin
        xSize := 6;
        ySize := 6;
        Level := 20;
        FacId := FID_Farm;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIelFarmConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The Farm is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIelFarm])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIFarms;
    ...
    with TMetaFacility.Create( tidFacility_PGIMassiveFarm, 'Large Farm', vidFacility_PGIMassiveFarm, TFacility ) do
      begin
        xSize := 7;
        ySize := 7;
        Level := 20;
        FacId := FID_Farm;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIMassiveFarmConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The Farm is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIMassiveFarm])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIFarms;
 ...
 {$IFDEF newpack}
    // Cattlefarma Small
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallCattlefarmaConstr,
      cost_CattlefarmaSmall,
      [80, 20, 0],
      15,
      TBlockUnderConstruction ) do
      begin
    ...
    with TMetaCattlefarmaBlock.Create(
      tidBlock_PGISmallCattlefarma,
      [input_CattlefarmaSmall_ExecutivesWorkForce, input_CattlefarmaSmall_ProfessionalWorkForce, input_CattlefarmaSmall_Workers],
      input_CattlefarmaSmall_Chemicals,
      0, // input_FarmSmall_LegalServices,
      0, // input_FarmSmall_ComputerServices,
      output_CattlefarmaSmall_FreshFood,
      output_CattlefarmaSmall_OrganicMaterials,
      budget_CattlefarmaSmall,
      TCattlefarmaBlock ) do
      begin
        VisualStages := 1;
        Beauty := -20;
      //BeautyStrength := 0.1;
    ...
    with TMetaFacility.Create( tidFacility_PGISmallCattlefarma, 'Farm', vidFacility_PGISmallCattlefarma, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 20;
        FacId := FID_Cattlefarma;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallCattlefarmaConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The farm is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallCattlefarma])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIFarms;
        TechnologyKind := tidLicence_Cattlefarma;
        MinistryId := nidMinistry_Agriculture;
        Register( tidClassFamily_Facilities );
      end;
    ...
    with TMetaCattlefarmaBlock.Create(
      tidBlock_PGICattlefarma,
      [input_Cattlefarma_ExecutivesWorkForce, input_Cattlefarma_ProfessionalWorkForce, input_Cattlefarma_Workers],
      input_Cattlefarma_Chemicals,
      0, // input_Farm_LegalServices,
      0, // input_Farm_ComputerServices,
      output_Cattlefarma_FreshFood,
      output_Cattlefarma_OrganicMaterials,
      budget_Cattlefarma,
      TCattlefarmaBlock ) do
      begin
        Beauty := -50;
    ...
    with TMetaFacility.Create( tidFacility_PGICattlefarma, 'Large Farm', vidFacility_PGICattlefarma, TFacility ) do
      begin
        xSize := 4;
        ySize := 4;
        Level := 20;
        FacId := FID_Cattlefarma;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGICattlefarmaConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The Farm is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGICattlefarma])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIFarms;
        TechnologyKind := tidInventionKind_LargeCattlefarma;
        MinistryId := nidMinistry_Agriculture;
        Register( tidClassFamily_Facilities );
      end;
    // burgerfact Small
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallburgerfactConstr,
      cost_burgerfactSmall,
      [80, 20, 0],
      15,
      TBlockUnderConstruction ) do
      begin
    ...
    with TMetaburgerfactBlock.Create(
      tidBlock_PGISmallburgerfact,
      [input_burgerfactSmall_ExecutivesWorkForce, input_burgerfactSmall_ProfessionalWorkForce, input_burgerfactSmall_Workers],
      input_burgerfactSmall_Chemicals,
      0, // input_FarmSmall_LegalServices,
      0, // input_FarmSmall_ComputerServices,
      output_burgerfactSmall_FreshFood,
      //output_CattlefarmaSmall_OrganicMaterials,
      budget_burgerfactSmall,
      TburgerfactBlock ) do
      begin
        VisualStages := 1;
        Beauty := -20;
    ...
    with TMetaFacility.Create( tidFacility_PGISmallburgerfact, 'Farm', vidFacility_PGISmallburgerfact, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 20;
        FacId := FID_burgerfact;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallburgerfactConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The farm is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallburgerfact])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_burgerfact;
        MinistryId := nidMinistry_Agriculture;
        Register( tidClassFamily_Facilities );
      end;
    ...
    with TMetaburgerfactBlock.Create(
      tidBlock_PGIburgerfact,
      [input_burgerfact_ExecutivesWorkForce, input_burgerfact_ProfessionalWorkForce, input_burgerfact_Workers],
      input_burgerfact_Chemicals,
      0, // input_Farm_LegalServices,
      0, // input_Farm_ComputerServices,
      output_burgerfact_FreshFood,
      //output_Cattlefarma_OrganicMaterials,
      budget_burgerfact,
      TburgerfactBlock ) do
      begin
    ...
    with TMetaFacility.Create( tidFacility_PGIburgerfact, 'Large Farm', vidFacility_PGIburgerfact, TFacility ) do
      begin
        xSize := 4;
        ySize := 4;
        Level := 20;
        FacId := FID_burgerfact;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIburgerfactConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The Farm is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIburgerfact])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidInventionKind_Largeburgerfact;
        MinistryId := nidMinistry_Agriculture;
        Register( tidClassFamily_Facilities );
      end;
     // Small rawChemMine
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallrawChemMineConstr,
      cost_rawChemMineSmall,
      [45, 40, 15],
      35,
      TBlockUnderConstruction ) do
      begin
    ...
    with TMetarawChemMineBlock.Create(
      tidBlock_PGISmallrawChemMine,
      [input_rawChemMineSmall_ExecutivesWorkForce, input_rawChemMineSmall_ProfessionalWorkForce, input_rawChemMineSmall_Workers],
      input_rawChemMineSmall_LegalServices,
      input_rawChemMineSmall_ComputerServices,
      input_rawChemMineSmall_Chemicals,
      output_rawChemMineSmall_Ore,
      budget_rawChemMineSmall,
      TrawChemMineBlock ) do
      begin
        Beauty := -100;
      //BeautyStrength := 1;
        Register( tidClassFamily_Blocks );
      end;
    with TMetaFacility.Create( tidFacility_PGISmallrawChemMine, 'rawChemMine', vidFacility_PGISmallrawChemMine, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 12;
        FacId := FID_rawChemMine;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallrawChemMineConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The mine is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallrawChemMine])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_rawChemMine;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
    ...
    with TMetarawChemMineBlock.Create(
      tidBlock_PGIrawChemMine,
      [input_rawChemMine_ExecutivesWorkForce, input_rawChemMine_ProfessionalWorkForce, input_rawChemMine_Workers],
      input_rawChemMine_LegalServices,
      input_rawChemMine_ComputerServices,
      input_rawChemMine_Chemicals,
      output_rawChemMine_Ore,
      budget_rawChemMine,
      TrawChemMineBlock ) do
      begin
        Beauty := -100;
    ...
    with TMetaFacility.Create( tidFacility_PGIrawChemMine, 'Large rawChemMine', vidFacility_PGIrawChemMine, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 12;
        FacId := FID_rawChemMine;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIrawChemMineConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The mine is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIrawChemMine])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidInventionKind_LargerawChemMine;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
   // Small miningchem plant
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallminingchemConstr,
      cost_miningchemSmall,
      [50, 40, 10],
      50,
      TBlockUnderConstruction ) do
      begin
    ...
    with TMetaminingchemBlock.Create(
      tidBlock_PGISmallminingchem,
      [input_miningchemSmall_ExecutivesWorkForce, input_miningchemSmall_ProfessionalWorkForce, input_miningchemSmall_Workers],
      input_miningchemSmall_LegalServices,
      input_miningchemSmall_ComputerServices,
      input_miningchemSmall_Ore,
      output_miningchemSmall_Chemicals,
      budget_miningchemSmall,
      TminingchemBlock ) do
      begin
        Beauty := -40;
      //BeautyStrength := 1;
    ...
    with TMetaFacility.Create( tidFacility_PGISmallminingchem, 'Chemical Plant', vidFacility_PGISmallminingchem, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 15;
        FacId := FID_miningchem;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallminingchemConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallminingchem])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_miningchem;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
    ...
    with TMetaminingchemBlock.Create(
      tidBlock_PGIminingchem,
      [input_miningchem_ExecutivesWorkForce, input_miningchem_ProfessionalWorkForce, input_miningchem_Workers],
      input_miningchem_LegalServices,
      input_miningchem_ComputerServices,
      input_miningchem_Ore,
      output_miningchem_Chemicals,
      budget_miningchem,
      TminingchemBlock ) do
      begin
        Beauty := -40;
    ...
    with TMetaFacility.Create( tidFacility_PGIminingchem, 'Large miningchem', vidFacility_PGIminingchem, TFacility ) do
      begin
        xSize := 5;
        ySize := 5;
        Level := 15;
        FacId := FID_miningchem;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIminingchemConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIminingchem])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidInventionKind_Largeminingchem;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
   // Small leather plant
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallleatherConstr,
      cost_leatherSmall,
      [50, 40, 10],
      50,
      TBlockUnderConstruction ) do
    ...
    with TMetaleatherBlock.Create(
      tidBlock_PGISmallleather,
      [input_leatherSmall_ExecutivesWorkForce, input_leatherSmall_ProfessionalWorkForce, input_leatherSmall_Workers],
      input_leatherSmall_LegalServices,
      input_leatherSmall_ComputerServices,
      input_leatherSmall_Ore,
      output_leatherSmall_Chemicals,
      budget_leatherSmall,
      TleatherBlock ) do
      begin
        Beauty := -40;
    ...
    with TMetaFacility.Create( tidFacility_PGISmallleather, 'leather Plant', vidFacility_PGISmallleather, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 15;
        FacId := FID_leather;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallleatherConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallleather])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_leather;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
    ...
    with TMetaleatherBlock.Create(
      tidBlock_PGIleather,
      [input_leather_ExecutivesWorkForce, input_leather_ProfessionalWorkForce, input_leather_Workers],
      input_leather_LegalServices,
      input_leather_ComputerServices,
      input_leather_Ore,
      output_leather_Chemicals,
      budget_leather,
      TleatherBlock ) do
      begin
        Beauty := -40;
    ...
    with TMetaFacility.Create( tidFacility_PGIleather, 'Large leather', vidFacility_PGIleather, TFacility ) do
      begin
        xSize := 5;
        ySize := 5;
        Level := 15;
        FacId := FID_leather;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIleatherConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIleather])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidInventionKind_Largeleather;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
   // Small leatherjacket industry
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallleatherjacketConstr,
      cost_leatherjacketSmall,
      [50, 40, 10],
      30,
      TBlockUnderConstruction) do
      begin
    ...
    with TMetaleatherjacketBlock.Create(
      tidBlock_PGISmallleatherjacket,
      [input_leatherjacketSmall_ExecutivesWorkForce, input_leatherjacketSmall_ProfessionalWorkForce, input_leatherjacketSmall_Workers],
      input_leatherjacketSmall_FabricsandThreads,
      input_leatherjacketSmall_OrganicMaterials,
      //input_leatherjacketSmall_Chemicals,
      input_leatherjacketSmall_ComputerServices,
      input_leatherjacketSmall_LegalServices,
      output_leatherjacketSmall_Cheapclothing,
      budget_leatherjacketSmall,
      TleatherjacketBlock ) do
      begin
        Beauty := -20;
      //BeautyStrength := 0.5;
        Register( 'Blocks' );
      end;
    with TMetaFacility.Create( tidFacility_PGISmallleatherjacket, 'leatherjacket Industry', vidFacility_PGISmallleatherjacket, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 40;
        FacId := FID_leatherjacket;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallleatherjacketConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallleatherjacket])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_leatherjacket;
        MinistryId := nidMinistry_LightIndustry;
        Register( tidClassFamily_Facilities );
      end;

    // leatherjacket industry
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGIleatherjacketConstr,
      cost_leatherjacket,
      [50, 40, 10],
      30,
      TBlockUnderConstruction) do
    ...
    with TMetaleatherjacketBlock.Create(
      tidBlock_PGIleatherjacket,
      [input_leatherjacket_ExecutivesWorkForce, input_leatherjacket_ProfessionalWorkForce, input_leatherjacket_Workers],
      input_leatherjacket_FabricsandThreads,
      input_leatherjacket_OrganicMaterials,
      //input_leatherjacket_Chemicals,
      input_leatherjacket_ComputerServices,
      input_leatherjacket_LegalServices,
      output_leatherjacket_Cheapclothing,
      budget_leatherjacket,
      TleatherjacketBlock ) do
      begin
        Beauty := -20;
      //BeautyStrength := 0.5;
    ...
    with TMetaFacility.Create( tidFacility_PGIleatherjacket, 'Large leatherjacket Industry', vidFacility_PGIleatherjacket, TFacility ) do
      begin
        xSize := 5;
        ySize := 5;
        Level := 40;
        FacId := FID_leatherjacket;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIleatherjacketConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIleatherjacket])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidInventionKind_Largeleatherjacket;
        MinistryId := nidMinistry_LightIndustry;
        Register( tidClassFamily_Facilities );
      end;
    logs.Log('pgi','start new indy');

    // Small coppermine
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallcoppermineConstr,
      cost_coppermineSmall,
      [45, 40, 15],
      35,
      TBlockUnderConstruction ) do
      begin
    ...
    with TMetacoppermineBlock.Create(
      tidBlock_PGISmallcoppermine,
      [input_coppermineSmall_ExecutivesWorkForce, input_coppermineSmall_ProfessionalWorkForce, input_coppermineSmall_Workers],
      input_coppermineSmall_LegalServices,
      input_coppermineSmall_ComputerServices,
      input_coppermineSmall_Chemicals,
      output_coppermineSmall_Ore,
      budget_coppermineSmall,
      TcoppermineBlock ) do
      begin
        Beauty := -100;
      //BeautyStrength := 1;
    ...
    with TMetaFacility.Create( tidFacility_PGISmallcoppermine, 'Mine', vidFacility_PGISmallcoppermine, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 12;
        FacId := FID_coppermine;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallcoppermineConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The mine is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallcoppermine])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;      
        TechnologyKind := tidLicence_coppermine;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
    ...
    with TMetacoppermineBlock.Create(
      tidBlock_PGIcoppermine,
      [input_coppermine_ExecutivesWorkForce, input_coppermine_ProfessionalWorkForce, input_coppermine_Workers],
      input_coppermine_LegalServices,
      input_coppermine_ComputerServices,
      input_coppermine_Chemicals,
      output_coppermine_Ore,
      budget_coppermine,
      TcoppermineBlock ) do
      begin
        Beauty := -100;
    ...
    with TMetaFacility.Create( tidFacility_PGIcoppermine, 'Large Mine', vidFacility_PGIcoppermine, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 12;
        FacId := FID_coppermine;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIcoppermineConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The mine is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIcoppermine])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidInventionKind_Largecoppermine;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
      logs.Log('pgi','copper');
    // Small ceramicMine
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallceramicMineConstr,
      cost_ceramicMineSmall,
      [45, 40, 15],
      35,
      TBlockUnderConstruction ) do
      begin
    ...
    with TMetaceramicMineBlock.Create(
      tidBlock_PGISmallceramicMine,
      [input_ceramicMineSmall_ExecutivesWorkForce, input_ceramicMineSmall_ProfessionalWorkForce, input_ceramicMineSmall_Workers],
      input_ceramicMineSmall_LegalServices,
      input_ceramicMineSmall_ComputerServices,
      input_ceramicMineSmall_Chemicals,
      output_ceramicMineSmall_Ore,
      budget_ceramicMineSmall,
      TceramicMineBlock ) do
      begin
        Beauty := -100;
      //BeautyStrength := 1;
        Register( tidClassFamily_Blocks );
      end;
    with TMetaFacility.Create( tidFacility_PGISmallceramicMine, 'Silicon Mine', vidFacility_PGISmallceramicMine, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 12;
        FacId := FID_ceramicMine;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallceramicMineConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The mine is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallceramicMine])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_ceramicMine;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
    ...
    with TMetaceramicMineBlock.Create(
      tidBlock_PGIceramicMine,
      [input_ceramicMine_ExecutivesWorkForce, input_ceramicMine_ProfessionalWorkForce, input_ceramicMine_Workers],
      input_ceramicMine_LegalServices,
      input_ceramicMine_ComputerServices,
      input_ceramicMine_Chemicals,
      output_ceramicMine_Ore,
      budget_ceramicMine,
      TceramicMineBlock ) do
      begin
        Beauty := -100;
    ...
    with TMetaFacility.Create( tidFacility_PGIceramicMine, 'Large Silicon Mine', vidFacility_PGIceramicMine, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 12;
        FacId := FID_ceramicMine;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIceramicMineConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The mine is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIceramicMine])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidInventionKind_LargeceramicMine;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
      logs.Log('pgi','ceramic');
   // Small pineoil
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallpineoilConstr,
      cost_pineoilSmall,
      [45, 40, 15],
      35,
      TBlockUnderConstruction ) do
    ...
    with TMetapineoilBlock.Create(
      tidBlock_PGISmallpineoil,
      [input_pineoilSmall_ExecutivesWorkForce, input_pineoilSmall_ProfessionalWorkForce, input_pineoilSmall_Workers],
      input_pineoilSmall_LegalServices,
      input_pineoilSmall_ComputerServices,
      input_pineoilSmall_Chemicals,
      output_pineoilSmall_Ore,
      budget_pineoilSmall,
      TpineoilBlock ) do
      begin
        Beauty := -100;
    ...
    with TMetaFacility.Create( tidFacility_PGISmallpineoil, 'Coal Mine', vidFacility_PGISmallpineoil, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 12;
        FacId := FID_pineoil;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallpineoilConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The mine is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallpineoil])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_pineoil;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
    ...
    with TMetapineoilBlock.Create(
      tidBlock_PGIpineoil,
      [input_pineoil_ExecutivesWorkForce, input_pineoil_ProfessionalWorkForce, input_pineoil_Workers],
      input_pineoil_LegalServices,
      input_pineoil_ComputerServices,
      input_pineoil_Chemicals,
      output_pineoil_Ore,
      budget_pineoil,
      TpineoilBlock ) do
      begin
    ...
    with TMetaFacility.Create( tidFacility_PGIpineoil, 'Large Coal Mine', vidFacility_PGICoalMine, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 12;
        FacId := FID_pineoil;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIpineoilConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The mine is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIpineoil])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidInventionKind_Largepineoil;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
      logs.Log('pgi','pine oil');
  { // Small copperIndustry
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallcopperIndustryConstr,
      cost_copperIndustrySmall,
      [40, 50, 10],
      55,
      TBlockUnderConstruction ) do
      begin
      ...
      logs.Log('pgi','small copper constcreate');
    with TMetacopperIndustryBlock.Create(
      tidBlock_PGIcopperIndustry,
      [0, input_copperIndustrySmall_ProfessionalWorkForce, input_copperIndustrySmall_Workers],
      input_copperIndustrySmall_Ore,
      input_copperIndustrySmall_LegalServices,
      input_copperIndustrySmall_ComputerServices,
      output_copperIndustrySmall_Metal,
      budget_copperIndustrySmall,
      TcopperIndustryBlock ) do
      begin
        Beauty := -100;
      //BeautyStrength := 1;
        Register( 'Blocks' );
      end;
      logs.Log('pgi','small copper block create');
    with TMetaFacility.Create( tidFacility_PGISmallcopperIndustry, 'Metallurgic Industry', vidFacility_PGISmallcopperIndustry, TFacility ) do
      begin
      logs.Log('pgi','small copper meta start');
        xSize := 4;
        ySize := 4;
        Level := 30;
        logs.Log('pgi','size');
        FacId := FID_copperIndustry;
        logs.Log('pgi','small copper fid');
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallcopperIndustryConstr])));
        logs.Log('pgi','small copper evl1');
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallcopperIndustry])));
        logs.Log('pgi','small copper evl2');
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_copperIndustry;
        logs.Log('pgi','small copperlic');
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
        logs.Log('pgi','small copper reg');
      end;
        logs.Log('pgi','small copper done');   }
    // Small copperIndustry
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallcopperIndustryConstr,
      cost_copperIndustrySmall,
    ...
    with TMetacopperIndustryBlock.Create(
      tidBlock_PGISmallcopperIndustry,
      [0{input_MetalurgicSmall_ExecutivesWorkForce}, input_copperIndustrySmall_ProfessionalWorkForce, input_copperIndustrySmall_Workers],
      input_copperIndustrySmall_Ore,
      input_copperIndustrySmall_LegalServices,
      input_copperIndustrySmall_ComputerServices,
      output_copperIndustrySmall_Metal,
    ...
    with TMetaFacility.Create( tidFacility_PGISmallcopperIndustry, 'Metallurgic Industry', vidFacility_PGISmallcopperIndustry, TFacility ) do
      begin
        ...
        logs.Log('pgi','small copperlic');
        MinistryId := nidMinistry_HeavyIndustry;
        logs.Log('pgi','small copper min id');
        Register( tidClassFamily_Facilities );
        logs.Log('pgi','small copper reg');
      end;
    // copperIndustry
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGIcopperIndustryConstr,
      cost_copperIndustry,
      [40, 50, 10],
      55,
      TBlockUnderConstruction ) do
    ...
    with TMetacopperIndustryBlock.Create(
      tidBlock_PGIcopperIndustry,
      [input_copperIndustry_ExecutivesWorkForce, input_copperIndustry_ProfessionalWorkForce, input_copperIndustry_Workers],
      input_copperIndustry_Ore,
      input_copperIndustry_LegalServices,
      input_copperIndustry_ComputerServices,
      output_copperIndustry_Metal,
      budget_copperIndustry,
      TcopperIndustryBlock ) do
      begin
        Beauty := -100;
      //BeautyStrength := 1;
      ...
      logs.Log('pgi','large copper meta create');
    with TMetaFacility.Create( tidFacility_PGIcopperIndustry, 'Large Metallurgic Industry', vidFacility_PGIcopperIndustry, TFacility ) do
      begin
        xSize := 5;
        ySize := 5;
        Level := 30;
        FacId := FID_copperIndustry;
        logs.Log('pgi','large copper eval');
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIcopperIndustryConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIcopperIndustry])));
        logs.Log('pgi','large copper eval done');
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidInventionKind_LargecopperIndustry;
        MinistryId := nidMinistry_HeavyIndustry;
        logs.Log('pgi','large copper ministry');
        Register( tidClassFamily_Facilities );
        logs.Log('pgi','large copper reg');
      end;
      logs.Log('pgi','copper indy'); { }
   // Small CPU
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallCPUConstr,
      cost_CPUSmall,
      [40, 40, 20],
      35,
      TBlockUnderConstruction ) do
    ...
    with TMetaCPUBlock.Create(
      tidBlock_PGISmallCPU,
      [input_CPUSmall_ExecutivesWorkForce, input_CPUSmall_ProfessionalWorkForce, input_CPUSmall_Workers],
      input_CPUSmall_Metal/2,
      input_CPUSmall_Metal/2,
      input_CPUSmall_Metal2,
      input_CPUSmall_Chemicals,
      input_CPUSmall_ComputerServices,
      input_CPUSmall_LegalServices,
      output_CPUSmall_Electroniccomponents,
      budget_CPUSmall,
      TCPUBlock ) do
      begin
        Beauty := -40;
    ...
    with TMetaFacility.Create( tidFacility_PGISmallCPU, 'Electronic Industry', vidFacility_PGISmallCPU, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 20;
        FacId := FID_CPU;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires Electronic materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallCPUConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallCPU])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_CPU;
        MinistryId := nidMinistry_LightIndustry;
        Register( tidClassFamily_Facilities );
      end;
    ...
    with TMetaCPUBlock.Create(
      tidBlock_PGICPU,
      [input_CPU_ExecutivesWorkForce, input_CPU_ProfessionalWorkForce, input_CPU_Workers],
      input_CPU_Metal/2,
      input_CPU_Metal/2,
      input_CPU_Metal2,
      input_CPU_Chemicals,
      input_CPU_ComputerServices,
      input_CPU_LegalServices,
      output_CPU_Electroniccomponents,
      budget_CPU,
      TCPUBlock ) do
      begin
        Beauty := -40;
    ...
    with TMetaFacility.Create( tidFacility_PGICPU, 'Large Electronic Industry', vidFacility_PGICPU, TFacility ) do
      begin
        xSize := 5;
        ySize := 5;
        Level := 20;
        FacId := FID_CPU;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires Electronic materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGICPUConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGICPU])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidInventionKind_LargeCPU;
        MinistryId := nidMinistry_LightIndustry;
        Register( tidClassFamily_Facilities );
      end;
      logs.Log('pgi','cpu');
    ...
    with TMetasportscarBlock.Create(
      tidBlock_PGIsportscar,
      [input_sportscar_ExecutivesWorkForce, input_sportscar_ProfessionalWorkForce, input_sportscar_Workers],
      input_sportscar_Metal,
      input_sportscar_FabricsAndThreads,
      input_sportscar_ElectronicComponents,
      input_sportscar_Chemicals,
      input_sportscar_Plastics,
      input_sportscar_ComputerServices,
      input_sportscar_LegalServices,
      output_sportscar_NiceCars,
      budget_sportscar,
      TsportscarBlock ) do
      begin
        Beauty := -40;
      ...
      logs.Log('pgi','sports');
    with TMetaFacility.Create( tidFacility_PGIsportscar, 'Car Factory', vidFacility_PGIsportscar, TFacility ) do
      begin
        xSize := 4;
        ySize := 4;
        Level := 40;
        FacId := FID_sportscar;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires Heavy materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIsportscarConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIsportscar])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_sportscar;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
   // Small PCs
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISmallPCsConstr,
      cost_PCsSmall,
      [45, 40, 15],
      35,
      TBlockUnderConstruction ) do
    ...
    with TMetaPCsBlock.Create(
      tidBlock_PGISmallPCs,
      [input_PCsSmall_ExecutivesWorkForce, input_PCsSmall_ProfessionalWorkForce, input_PCsSmall_Workers],
      input_PCsSmall_Metal,
      input_PCsSmall_ElectronicComponents,
      input_PCsSmall_Chemicals,
      input_PCsSmall_Plastics,
      input_PCsSmall_ComputerServices,
      input_PCsSmall_LegalServices,
      output_PCsSmall_HouseHoldingAppliances,
      budget_PCsSmall,
      TPCsBlock ) do
      begin
        Beauty := -40;
    ...
    with TMetaFacility.Create( tidFacility_PGISmallPCs, 'Appliances Factory', vidFacility_PGISmallPCs, TFacility ) do
      begin
        xSize := 3;
        ySize := 3;
        Level := 40;
        FacId := FID_PCs;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires Heavy materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallPCsConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISmallPCs])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_PCs;
        MinistryId := nidMinistry_LightIndustry;
        Register( tidClassFamily_Facilities );
      end;
    ...
    with TMetaPCsBlock.Create(
      tidBlock_PGIPCs,
      [input_PCs_ExecutivesWorkForce, input_PCs_ProfessionalWorkForce, input_PCs_Workers],
      input_PCs_Metal,
      input_PCs_ElectronicComponents,
      input_PCs_Chemicals,
      input_PCs_Plastics,
      input_PCs_ComputerServices,
      input_PCs_LegalServices,
      output_PCs_HouseHoldingAppliances,
      budget_PCs,
      TPCsBlock ) do
      begin
        Beauty := -40;
    ...
    with TMetaFacility.Create( tidFacility_PGIPCs, 'Large Appliances Factory', vidFacility_PGIPCs, TFacility ) do
      begin
        xSize := 5;
        ySize := 5;
        Level := 40;
        FacId := FID_PCs;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires Heavy materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIPCsConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIPCs])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidInventionKind_LargePCs;
        MinistryId := nidMinistry_LightIndustry;
        Register( tidClassFamily_Facilities );
      end;
   ...
   // concrete industry
    ...
    with TMetaconcreteBlock.Create(
      tidBlock_PGIconcrete,
      [input_concrete_ExecutivesWorkForce, input_concrete_ProfessionalWorkForce, input_concrete_Workers],
      input_concrete_Ore,
      input_concrete_Metal,
      input_concrete_Chemicals,
      input_concrete_LegalServices,
      input_concrete_ComputerServices,
      output_concrete_Construction,
      budget_concrete,
      TconcreteBlock ) do
      begin
        Beauty := -50;
    ...
    with TMetaFacility.Create( tidFacility_PGIconcrete, 'Construction Industry', vidFacility_PGIconcrete, TFacility ) do
      begin
        xSize := 4;
        ySize := 4;
        Level := 20;
        FacId := FID_concrete;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIconcreteConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIconcrete])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_concrete;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
   // machineindy2 industry
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGImachineindy2Constr,
      cost_machineindy2,
      [45, 40, 15],
      60,
      TBlockUnderConstruction ) do
    ...
    with TMetamachineindy2Block.Create(
      tidBlock_PGImachineindy2,
      [input_machineindy2_ExecutivesWorkForce, input_machineindy2_ProfessionalWorkForce, input_machineindy2_Workers],
      input_machineindy2_Metal,
      input_machineindy2_Chemicals,
      input_machineindy2_ElectronicComponents,
      input_machineindy2_ComputerServices,
      input_machineindy2_LegalServices,
      output_machineindy2_Machinery,
      budget_machineindy2,
      Tmachineindy2Block ) do
      begin
        Beauty := -50;
      //BeautyStrength := 0.5;
        Register( 'Blocks' );
      end;
    with TMetaFacility.Create( tidFacility_PGImachineindy2, 'Machinery Industry', vidFacility_PGImachineindy2, TFacility ) do
      begin
        xSize := 5;
        ySize := 5;
        Level := 20;
        FacId := FID_machineindy2;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires Heavy materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGImachineindy2Constr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGImachineindy2])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_machineindy2;
        MinistryId := nidMinistry_HeavyIndustry;
        Register( tidClassFamily_Facilities );
      end;
   // servers
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGIserversConstr,
      cost_servers,
      [40, 40, 20],
      40,
      TBlockUnderConstruction ) do
    ...
    with TMetaserversBlock.Create(
      tidBlock_PGIservers,
      [input_servers_ExecutivesWorkForce, input_servers_ProfessionalWorkForce, input_servers_Workers],
      input_servers_Metal,
      input_servers_Chemicals,
      input_servers_Plastics,
      input_servers_ElectronicComponents,
      input_servers_ComputerServices,
      input_servers_LegalServices,
      output_servers_BusinessMachines,
      budget_servers,
      TserversBlock ) do
      begin
        Beauty := -40;
    ...
    with TMetaFacility.Create( tidFacility_PGIservers, 'Business Machines Industry', vidFacility_PGIservers, TFacility ) do
      begin
        xSize := 4;
        ySize := 4;
        Level := 40;
        FacId := FID_servers;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires Heavy materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIserversConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The industry is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIservers])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIIndustrialFacilities;
        TechnologyKind := tidLicence_servers;
        MinistryId := nidMinistry_LightIndustry;
        Register( tidClassFamily_Facilities );
      end;


    logs.Log('pgi','end new indy');
  {$ENDIF}
 //end indy     leatherjacket
  end;
...
procedure RegisterStores;
  begin
    // new         Mallcloth1
    {$IFDEF newpack}
    logs.Log('pgi','start new com');
     // Supermarket A      Mallcloth1
    with TMetaBlockUnderConstruction.Create(
    ...
    with TMetaMallcloth1Block.Create(
    ...
    with TMetaMallcloth2Block.Create(
    ...
    with TMetaMallcloth3Block.Create(
    ...
    // Car Store
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGISportscarstoreConstr,
      500000,
      [90, 0, 10],
      35,
      TBlockUnderConstruction ) do
    ...
    with TMetaSportscarstoreBlock.Create(
      tidBlock_PGISportscarstore,
      [0, 1, 10],
      1/(24*7),
      2/(24*7),
      1,
      ...
      [0.38, 0.19, 0.05],
      140,
      TSportscarstoreBlock ) do
      begin
        Register( 'Blocks' );
      end;
    with TMetaFacility.Create( tidFacility_PGISportscarstore, 'Car Store', vidFacility_PGISportscarstore, TFacility ) do
      begin
        xSize := 2;
        ySize := 2;
        Level := 100;
        FacId := FID_Sportscarstore;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISportscarstoreConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The Shop is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGISportscarstore])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIServiceFacilities;
        TechnologyKind := tidInventionKind_ServiceFacilities;
        DepOnTech := false; // make available even without HQs
    ...
    logs.Log('pgi','end new com');
    // burgerbar
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGIburgerbarConstr,
      400000,
      [90, 0, 10],
      30,
      TBlockUnderConstruction ) do
    ...
    with TMetaburgerbarBlock.Create(
      tidBlock_PGIburgerbar,
      [0, 1, 25],
      50,
      FairPrice,
      [0.9, 0.8, 0.7],
    ...
    with TMetaFacility.Create( tidFacility_PGIburgerbar, 'burgerbar', vidFacility_PGIburgerbar, TFacility ) do
      begin
        xSize := 1;
        ySize := 1;
        Level := 1000;
        FacId := FID_burgerbar;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIburgerbarConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The Restaurant is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIburgerbar])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIServiceFacilities;
        TechnologyKind := tidInventionKind_ServiceFacilities;
        DepOnTech := false; // make available even without HQs
    ...
    //leatherjacketShop
    with TMetaBlockUnderConstruction.Create(
      tidBlock_PGIleatherjacketShopConstr,
      70000,
      [90, 0, 10],
      20,
      TBlockUnderConstruction ) do
    ...
    with TMetaleatherjacketShopBlock.Create(
      tidBlock_PGIleatherjacketShop,
      [0, 1, 10],
      10,
      FairPrice,
      [0.6, 0.6, 0.7],
      130,
      TleatherjacketShopBlock ) do
      begin
        Register( 'Blocks' );
      end;
    with TMetaFacility.Create( tidFacility_PGIleatherjacketShop, 'Food Store', vidFacility_PGIleatherjacketShop, TFacility ) do
      begin
        xSize := 1;
        ySize := 1;
        Level := 100;
        FacId := FID_leatherjacketShop;
        EvlStages.Insert( TEvlStage.Create( 'Construction', 'Under Construction', 'Requires construction materials to advance to the next stage.', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIleatherjacketShopConstr])));
        EvlStages.Insert( TEvlStage.Create( 'Complete', 'Completed', 'The Food Store is ready to operate', TMetaBlock(TheClassStorage.ClassById['Blocks', tidBlock_PGIleatherjacketShop])));
        ClusterName := tidClusterName_PGI;
        FacilityKind := tidFacilityKind_PGIServiceFacilities;
        TechnologyKind := tidInventionKind_ServiceFacilities;
        DepOnTech := false; // make available even without HQs
