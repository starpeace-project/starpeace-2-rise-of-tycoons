...
interface
  ...
  const
    tidBlock_PGIelFarmConstr = 'PGIelFarmConstr';
    tidBlock_PGIelFarm       = 'PGIelFarm';
    tidFacility_PGIelFarm    = 'PGIelFarm';
    vidFacility_PGIelFarm    = 7584;

  const
    tidBlock_PGImassiveFarmConstr = 'PGImassiveFarmConstr';
    tidBlock_PGImassiveFarm       = 'PGImassiveFarm';
    tidFacility_PGImassiveFarm    = 'PGImassiveFarm';
    vidFacility_PGImassiveFarm    = 7587;
 ...
 //new         burgerfact
   const
    tidBlock_PGISmallCattlefarmaConstr = 'PGISmallCattlefarmaConstr';
    tidBlock_PGISmallCattlefarma       = 'PGISmallCattlefarma';
    tidFacility_PGISmallCattlefarma    = 'PGISmallCattlefarma';
    vidFacility_PGISmallCattlefarma    = 10120;
   const
    tidBlock_PGICattlefarmaConstr = 'PGICattlefarmaConstr';
    tidBlock_PGICattlefarma       = 'PGICattlefarma';
    tidFacility_PGICattlefarma    = 'PGICattlefarma';
    vidFacility_PGICattlefarma    = 10117;
   const
    tidBlock_PGISmallburgerfactConstr = 'PGISmallburgerfactConstr';
    tidBlock_PGISmallburgerfact       = 'PGISmallburgerfact';
    tidFacility_PGISmallburgerfact    = 'PGISmallburgerfact';
    vidFacility_PGISmallburgerfact    = 10126;
   const
    tidBlock_PGIburgerfactConstr = 'PGIburgerfactConstr';
    tidBlock_PGIburgerfact       = 'PGIburgerfact';
    tidFacility_PGIburgerfact    = 'PGIburgerfact';
    vidFacility_PGIburgerfact    = 10123;
  const
    tidBlock_PGISmallrawChemMineConstr = 'PGISmallrawChemMineConstr';
    tidBlock_PGISmallrawChemMine       = 'PGISmallrawChemMine';
    tidFacility_PGISmallrawChemMine    = 'PGISmallrawChemMine';
    vidFacility_PGISmallrawChemMine    = 10134;
   const
    tidBlock_PGIrawChemMineConstr = 'PGIrawChemMineConstr';
    tidBlock_PGIrawChemMine       = 'PGIrawChemMine';
    tidFacility_PGIrawChemMine    = 'PGIrawChemMine';
    vidFacility_PGIrawChemMine    = 10129;
   const
    tidBlock_PGISmallminingchemConstr = 'PGISmallminingchemConstr';
    tidBlock_PGISmallminingchem       = 'PGISmallminingchem';
    tidFacility_PGISmallminingchem    = 'PGISmallminingchem';
    vidFacility_PGISmallminingchem    = 10142;
   const
    tidBlock_PGIminingchemConstr = 'PGIminingchemConstr';
    tidBlock_PGIminingchem       = 'PGIminingchem';
    tidFacility_PGIminingchem    = 'PGIminingchem';
    vidFacility_PGIminingchem    = 10139;
   const
    tidBlock_PGISmallleatherConstr = 'PGISmallleatherConstr';
    tidBlock_PGISmallleather       = 'PGISmallleather';
    tidFacility_PGISmallleather    = 'PGISmallleather';
    vidFacility_PGISmallleather    = 10148;
   const
    tidBlock_PGIleatherConstr = 'PGIleatherConstr';
    tidBlock_PGIleather       = 'PGIleather';
    tidFacility_PGIleather    = 'PGIleather';
    vidFacility_PGIleather    = 10145;
   const
    tidBlock_PGISmallleatherjacketConstr = 'PGISmallleatherjacketConstr';
    tidBlock_PGISmallleatherjacket       = 'PGISmallleatherjacket';
    tidFacility_PGISmallleatherjacket    = 'PGISmallleatherjacket';
    vidFacility_PGISmallleatherjacket    = 10154;
   const
    tidBlock_PGIleatherjacketConstr = 'PGIleatherjacketConstr';
    tidBlock_PGIleatherjacket       = 'PGIleatherjacket';
    tidFacility_PGIleatherjacket    = 'PGIleatherjacket';
    vidFacility_PGIleatherjacket    = 10151;
   const
    tidBlock_PGIburgerbarConstr = 'PGIburgerbarConstr';
    tidBlock_PGIburgerbar       = 'PGIburgerbar';
    tidFacility_PGIburgerbar    = 'PGIburgerbar';
    vidFacility_PGIburgerbar    = 10157;
   const
    tidBlock_PGIleatherjacketShopConstr = 'PGIleatherjacketShopConstr';
    tidBlock_PGIleatherjacketShop       = 'PGIleatherjacketShop';
    tidFacility_PGIleatherjacketShop    = 'PGIleatherjacketShop';
    vidFacility_PGIleatherjacketShop    = 10160;
   const
    tidBlock_PGIcoppermineConstr = 'PGIcoppermineConstr';
    tidBlock_PGIcoppermine       = 'PGIcoppermine';
    tidFacility_PGIcoppermine    = 'PGIcoppermine';
    vidFacility_PGIcoppermine    = 12009;
   const
    tidBlock_PGISmallcoppermineConstr = 'PGISmallcoppermineConstr';
    tidBlock_PGISmallcoppermine      = 'PGISmallcoppermine';
    tidFacility_PGISmallcoppermine    = 'PGISmallcoppermine';
    vidFacility_PGISmallcoppermine    = 12012;
   const
    tidBlock_PGIceramicMineConstr = 'PGIceramicMineConstr';
    tidBlock_PGIceramicMine       = 'PGIceramicMine';
    tidFacility_PGIceramicMine    = 'PGIceramicMine';
    vidFacility_PGIceramicMine    = 10215;
   const
    tidBlock_PGISmallceramicMineConstr = 'PGISmallceramicMineConstr';
    tidBlock_PGISmallceramicMine      = 'PGISmallceramicMine';
    tidFacility_PGISmallceramicMine    = 'PGISmallceramicMine';
    vidFacility_PGISmallceramicMine    = 10218;
   const
    tidBlock_PGIpineoilConstr = 'PGIpineoilConstr';
    tidBlock_PGIpineoil       = 'PGIpineoil';
    tidFacility_PGIpineoil    = 'PGIpineoil';
    vidFacility_PGIpineoil    = 10221;
   const
    tidBlock_PGISmallpineoilConstr = 'PGISmallpineoilConstr';
    tidBlock_PGISmallpineoil      = 'PGISmallpineoil';
    tidFacility_PGISmallpineoil    = 'PGISmallpineoil';
    vidFacility_PGISmallpineoil    = 10224;
   const
    tidBlock_PGIcopperIndustryConstr = 'PGIcopperIndustryConstr';
    tidBlock_PGIcopperIndustry       = 'PGIcopperIndustry';
    tidFacility_PGIcopperIndustry    = 'PGIcopperIndustry';
    vidFacility_PGIcopperIndustry    = 10227;
   const
    tidBlock_PGISmallcopperIndustryConstr = 'PGISmallcopperIndustryConstr';
    tidBlock_PGISmallcopperIndustry      = 'PGISmallcopperIndustry';
    tidFacility_PGISmallcopperIndustry    = 'PGISmallcopperIndustry';
    vidFacility_PGISmallcopperIndustry    = 10230;
   const
    tidBlock_PGICPUConstr = 'PGICPUConstr';
    tidBlock_PGICPU       = 'PGICPU';
    tidFacility_PGICPU    = 'PGICPU';
    vidFacility_PGICPU    = 10233;
   const
    tidBlock_PGISmallCPUConstr = 'PGISmallCPUConstr';
    tidBlock_PGISmallCPU      = 'PGISmallCPU';
    tidFacility_PGISmallCPU    = 'PGISmallCPU';
    vidFacility_PGISmallCPU    = 10236;
   const
    tidBlock_PGIsportscarConstr = 'PGIsportscarConstr';
    tidBlock_PGIsportscar       = 'PGIsportscar';
    tidFacility_PGIsportscar    = 'PGIsportscar';
    vidFacility_PGIsportscar    = 10239;
   const
    tidBlock_PGIPCsConstr = 'PGIPCsConstr';
    tidBlock_PGIPCs       = 'PGIPCs';
    tidFacility_PGIPCs    = 'PGIPCs';
    vidFacility_PGIPCs    = 10242;
   const
    tidBlock_PGISmallPCsConstr = 'PGISmallPCsConstr';
    tidBlock_PGISmallPCs      = 'PGISmallPCs';
    tidFacility_PGISmallPCs    = 'PGISmallPCs';
    vidFacility_PGISmallPCs    = 10245;
   const
    tidBlock_PGISportscarstoreConstr = 'PGISportscarstoreConstr';
    tidBlock_PGISportscarstore      = 'PGISportscarstore';
    tidFacility_PGISportscarstore    = 'PGISportscarstore';
    vidFacility_PGISportscarstore    = 10248;
   const
    tidBlock_PGIconcreteConstr = 'PGIconcreteConstr';
    tidBlock_PGIconcrete      = 'PGIconcrete';
    tidFacility_PGIconcrete    = 'PGIconcrete';
    vidFacility_PGIconcrete    = 10316;
   const
    tidBlock_PGImachineindy2Constr = 'PGImachineindy2Constr';
    tidBlock_PGImachineindy2      = 'PGImachineindy2';
    tidFacility_PGImachineindy2    = 'PGImachineindy2';
    vidFacility_PGImachineindy2    = 10313;
   const
    tidBlock_PGIserversConstr = 'PGIserversConstr';
    tidBlock_PGIservers      = 'PGIservers';
    tidFacility_PGIservers    = 'PGIservers';
    vidFacility_PGIservers    = 10319;
