...
interface
  ...
  const
    ...
    tidInventionKind_magOffices               = 'magOffices';
    ...
    tidInventionKind_Largeorganicwaste     = 'Largeorganicwaste';
    tidInventionKind_Largefert                = 'Largefertiliser';
    tidInventionKind_LargegrainFarma        = 'Largegrainfarma';
    tidInventionKind_Largemill        = 'Largemill';
    tidInventionKind_Largecotton        = 'Largecotton';
    tidInventionKind_Largetrouser        = 'Largetrouser';
    tidInventionKind_LargevegFarma       = 'Largevegfarma';
    tidInventionKind_Largestewfact = 'Largestewfact';
    tidInventionKind_LargeorganicMine = 'largeorganicMine';
    tidInventionKind_Largepolymer = 'Largepolymer';
    tidInventionKind_Largenylon = 'Largenylon';
    tidInventionKind_Largeshirt = 'Largeshirt';
    tidInventionKind_LargeCattlefarma = 'LargeCattlefarma';
    tidInventionKind_Largeburgerfact = 'Largeburgerfact';
    tidInventionKind_LargerawChemMine = 'LargerawChemMine';
    tidInventionKind_Largeminingchem = 'Largeminingchem';
    tidInventionKind_Largeleather = 'Largeleather';
    tidInventionKind_Largeleatherjacket = 'Largeleatherjacket';

    // extra Large Industries
    tidInventionKind_eLargeFarms            = 'eLargeFarms';

    // Massive Industries
    tidInventionKind_MassiveFarms            = 'MassiveFarms';
    ...
    tidInventionKind_bakery           = 'bakery';
    tidInventionKind_MovieTheaters         = 'Movies';
    tidInventionKind_magnaMovieTheaters         = 'MagnaMovies';
    tidInventionKind_Funerals              = 'Funerals';
    tidInventionKind_piestore              = 'FruitPieShop';
  ...
  const
    ...
    tidLicence_organicwaste                = 'organicwaste';
    tidLicence_fert                        = 'fertiliser';
    tidLicence_grainFarma                  = 'grainfarma';
    tidLicence_mill                        = 'mill';
    tidLicence_cotton                      = 'cotton';
    tidLicence_trouser                     = 'trouser';
    tidLicence_fruitFarma                  = 'fruitfarma';
    tidLicence_fruitpielarge = 'fruitpiefact';
    tidLicence_rubbersap = 'rubbersap';
    tidLicence_rubbertree = 'rubbertree';
    tidLicence_rubberfact = 'rubberfact';
    tidLicence_shoefact = 'shoefact';
    tidLicence_vegFarma = 'vegfarma';
    tidLicence_stewfact = 'stewfact';
    tidLicence_organicMine = 'organicMine';
    tidLicence_polymer = 'polymer';
    tidLicence_nylon = 'nylon';
    tidLicence_shirt = 'shirt';
    tidLicence_Cattlefarma = 'Cattlefarma';
    tidLicence_burgerfact = 'burgerfact';
    tidLicence_rawChemMine = 'rawChemMine';
    tidLicence_miningchem = 'miningchem';
    tidLicence_leather = 'leather';
    tidLicence_leatherjacket = 'leatherjacket';
    //brand new lump in 1
    tidLicence_ironMines                       = 'ironMines';
    tidInventionKind_LargeironMines            = 'LargeironMines';
    tidLicence_steel                       = 'steel';
    tidInventionKind_Largesteel            = 'Largesteel';
    tidLicence_Memory                       = 'Memory';
    tidInventionKind_LargeMemory            = 'LargeMemory';
    tidLicence_Smallcar                       = 'Smallcar';
    tidLicence_Tvs                       = 'Tvs';
    tidInventionKind_LargeTvs            = 'LargeTvs';
    tidLicence_coppermine                      = 'coppermine';
    tidInventionKind_Largecoppermine            = 'Largecoppermine';
    tidLicence_ceramicMine                      = 'ceramicMine';
    tidInventionKind_LargeceramicMine            = 'LargeceramicMine';
    tidLicence_pineoil                      = 'pineoil';
    tidInventionKind_Largepineoil            = 'Largepineoil';
    tidLicence_copperIndustry                      = 'copperIndustry';
    tidInventionKind_LargecopperIndustry            = 'LargecopperIndustry';
    tidLicence_CPU                      = 'CPU';
    tidInventionKind_LargeCPU            = 'LargeCPU';
    tidLicence_sportscar                      = 'sportscar';
    tidLicence_PCs                      = 'PCs';
    tidInventionKind_LargePCs            = 'LargePCs';
    tidLicence_almine                      = 'almine';
    tidInventionKind_Largealmine            = 'Largealmine';
    tidLicence_cryolite                      = 'cryolite';
    tidInventionKind_Largecryolite            = 'Largecryolite';
    tidLicence_silane                      = 'silane';
    tidInventionKind_Largesilane            = 'Largesilane';
    tidLicence_alIndustry                       = 'alIndustry';
    tidInventionKind_LargealIndustry             = 'LargealIndustry';
    tidLicence_tft                       = 'tft';
    tidInventionKind_Largetft             = 'Largetft';
    tidLicence_motorbike                       = 'motorbike';
    tidLicence_mphone                      = 'mphone';
    tidInventionKind_Largemphone             = 'Largemphone';
    tidLicence_engine             = 'engine';
    tidLicence_tire             = 'tire';
    tidLicence_humvee             = 'humvee';
    tidLicence_cooker             = 'cooker';
    tidLicence_glass             = 'glass';
    tidLicence_conveybsys             = 'conveybsys';
    tidLicence_buscomp             = 'buscomp';
    tidLicence_concrete             = 'concrete';
    tidLicence_machineindy2             = 'machineindy2';
    tidLicence_servers             = 'servers';
    tidLicence_plasterboard             = 'plasterboard';
    tidLicence_roboticsys             = 'roboticsys';
    tidLicence_bm2             = 'bm2';
    tidLicence_gypsum             = 'gypsum';
    tidLicence_limestone             = 'limestone';
    tidLicence_gravel             = 'gravel';
    tidLicence_const2             = 'const2';
    tidLicence_controlsys             = 'controlsys';
    tidLicence_networksys             = 'networksys';
