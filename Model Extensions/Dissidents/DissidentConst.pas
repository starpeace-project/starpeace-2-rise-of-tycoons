...
interface
  ...
  const
   ...
   const
    tidBlock_DisselFarmConstr = 'DisselFarmConstr';
    tidBlock_DisselFarm       = 'DisselFarm';
    tidFacility_DisselFarm    = 'DisselFarm';
    vidFacility_DisselFarm    = 20001;

    const
    tidBlock_DissMassiveFarmConstr = 'DissMassiveFarmConstr';
    tidBlock_DissMassiveFarm       = 'DissMassiveFarm';
    tidFacility_DissMassiveFarm    = 'DissMassiveFarm';
    vidFacility_DissMassiveFarm    = 20005;
  ...
  const
    tidBlock_DissorganicwasteConstr = 'DissorganicwasteConstr';
    tidBlock_Dissorganicwaste       = 'Dissorganicwaste';
    tidFacility_Dissorganicwaste    = 'Dissorganicwaste';
    vidFacility_Dissorganicwaste    = 10001;

  const
    tidBlock_DissorganicwasteSmallConstr = 'DissorganicwasteSmallConstr';
    tidBlock_DissorganicwasteSmall       = 'DissorganicwasteSmall';
    tidFacility_DissorganicwasteSmall    = 'DissorganicwasteSmall';
    vidFacility_DissorganicwasteSmall    = 10005;

  const
    tidBlock_DissfertConstr = 'DissfertConstr';
    tidBlock_Dissfert       = 'Dissfert';
    tidFacility_Dissfert    = 'Dissfert';
    vidFacility_Dissfert    = 10009;

  const
    tidBlock_DissfertSmallConstr = 'DissfertSmallConstr';
    tidBlock_DissfertSmall       = 'DissfertSmall';
    tidFacility_DissfertSmall    = 'DissfertSmall';
    vidFacility_DissfertSmall    = 10012;

  const
    tidBlock_DissgrainFarmaConstr = 'DissgrainFarmaConstr';
    tidBlock_DissgrainFarma       = 'DissgrainFarma';
    tidFacility_DissgrainFarma    = 'DissgrainFarma';
    vidFacility_DissgrainFarma    = 10015;
    
  const
    tidBlock_DissgrainFarmaSmallConstr = 'DissSmallgrainFarmaConstr';
    tidBlock_DissgrainFarmaSmall       = 'DissSmallgrainFarma';
    tidFacility_DissgrainFarmaSmall    = 'DissSmallgrainFarma';
    vidFacility_DissgrainFarmaSmall    = 10019;

  const
    tidBlock_DissmillConstr = 'DissmillConstr';
    tidBlock_Dissmill       = 'Dissmill';
    tidFacility_Dissmill    = 'Dissmill';
    vidFacility_Dissmill    = 10023;
    
  const
    tidBlock_DissmillSmallConstr = 'DissSmallmillConstr';
    tidBlock_DissmillSmall       = 'DissSmallmill';
    tidFacility_DissmillSmall    = 'DissSmallmill';
    vidFacility_DissmillSmall    = 10027;

  const
    tidBlock_DisscottonConstr = 'DisscottonConstr';
    tidBlock_Disscotton       = 'Disscotton';
    tidFacility_Disscotton    = 'Disscotton';
    vidFacility_Disscotton    = 10037;
    
  const
    tidBlock_DisscottonSmallConstr = 'DissSmallcottonConstr';
    tidBlock_DisscottonSmall       = 'DissSmallcotton';
    tidFacility_DisscottonSmall    = 'DissSmallcotton';
    vidFacility_DisscottonSmall    = 10040;

  const
    tidBlock_DisstrouserConstr = 'DisstrouserConstr';
    tidBlock_Disstrouser       = 'Disstrouser';
    tidFacility_Disstrouser    = 'Disstrouser';
    vidFacility_Disstrouser    = 10031;
    
  const
    tidBlock_DisstrouserSmallConstr = 'DissSmalltrouserConstr';
    tidBlock_DisstrouserSmall       = 'DissSmalltrouser';
    tidFacility_DisstrouserSmall    = 'DissSmalltrouser';
    vidFacility_DisstrouserSmall    = 10034;

  const
    tidBlock_DissbakeryConstr = 'DissbakeryConstr';
    tidBlock_Dissbakery       = 'Dissbakery';
    tidFacility_Dissbakery    = 'Dissbakery';
    vidFacility_Dissbakery    = 10046;

  const
    tidBlock_DisstrouserStoreConstr = 'DisstrouserStoreConstr';
    tidBlock_DisstrouserStore       = 'DisstrouserStore';
    tidFacility_DisstrouserStore    = 'DisstrouserStore';
    vidFacility_DisstrouserStore    = 10043;

  const
    tidBlock_DissironMineConstr = 'DissironMineConstr';
    tidBlock_DissironMine       = 'DissironMine';
    tidFacility_DissironMine    = 'DissironMine';
    vidFacility_DissironMine    = 10163;

  const
    tidBlock_DissironMineSmallConstr = 'DissironMineSmallConstr';
    tidBlock_DissironMineSmall       = 'DissironMineSmall';
    tidFacility_DissironMineSmall    = 'DissironMineSmall';
    vidFacility_DissironMineSmall    = 10167;

  const
    tidBlock_DissSiliconMine2Constr = 'DissSiliconMine2Constr';
    tidBlock_DissSiliconMine2       = 'DissSiliconMine2';
    tidFacility_DissSiliconMine2    = 'DissSiliconMine2';
    vidFacility_DissSiliconMine2    = 10171;

  const
    tidBlock_DissSiliconMine2SmallConstr = 'DissSiliconMine2SmallConstr';
    tidBlock_DissSiliconMine2Small       = 'DissSiliconMine2Small';
    tidFacility_DissSiliconMine2Small    = 'DissSiliconMine2Small';
    vidFacility_DissSiliconMine2Small    = 10175;

  const
    tidBlock_DissCoalMine2Constr = 'DissCoalMine2Constr';
    tidBlock_DissCoalMine2       = 'DissCoalMine2';
    tidFacility_DissCoalMine2    = 'DissCoalMine2';
    vidFacility_DissCoalMine2    = 10179;

  const
    tidBlock_DissCoalMine2SmallConstr = 'DissCoalMine2SmallConstr';
    tidBlock_DissCoalMine2Small       = 'DissCoalMine2Small';
    tidFacility_DissCoalMine2Small    = 'DissCoalMine2Small';
    vidFacility_DissCoalMine2Small    = 10183;

  const
    tidBlock_DisssteelConstr = 'DisssteelConstr';
    tidBlock_Disssteel       = 'Disssteel';
    tidFacility_Disssteel    = 'Disssteel';
    vidFacility_Disssteel    = 10187;

  const
    tidBlock_DisssteelSmallConstr = 'DisssteelSmallConstr';
    tidBlock_DisssteelSmall       = 'DisssteelSmall';
    tidFacility_DisssteelSmall    = 'DisssteelSmall';
    vidFacility_DisssteelSmall    = 10190;

  const
    tidBlock_DissMemoryConstr = 'DissMemoryConstr';
    tidBlock_DissMemory       = 'DissMemory';
    tidFacility_DissMemory    = 'DissMemory';
    vidFacility_DissMemory    = 10193;

  const
    tidBlock_DissMemorySmallConstr = 'DissMemorySmallConstr';
    tidBlock_DissMemorySmall       = 'DissMemorySmall';
    tidFacility_DissMemorySmall    = 'DissMemorySmall';
    vidFacility_DissMemorySmall    = 10196;

  const
    tidBlock_DissSmallcarConstr = 'DissSmallcarConstr';
    tidBlock_DissSmallcar       = 'DissSmallcar';
    tidFacility_DissSmallcar    = 'DissSmallcar';
    vidFacility_DissSmallcar    = 10199;

  const
    tidBlock_DissTvsConstr = 'DissTvsConstr';
    tidBlock_DissTvs       = 'DissTvs';
    tidFacility_DissTvs    = 'DissTvs';
    vidFacility_DissTvs    = 10202;

  const
    tidBlock_DissTvsSmallConstr = 'DissTvsSmallConstr';
    tidBlock_DissTvsSmall       = 'DissTvsSmall';
    tidFacility_DissTvsSmall    = 'DissTvsSmall';
    vidFacility_DissTvsSmall    = 10206;

  const
    tidBlock_DissTVStoreConstr = 'DissTVStoreConstr';
    tidBlock_DissTVStore       = 'DissTVStore';
    tidFacility_DissTVStore    = 'DissTVStore';
    vidFacility_DissTVStore    = 10210;

  const
    tidBlock_DissSmallcarstoreConstr = 'DissSmallcarstoreConstr';
    tidBlock_DissSmallcarstore       = 'DissSmallcarstore';
    tidFacility_DissSmallcarstore    = 'DissSmallcarstore';
    vidFacility_DissSmallcarstore    = 10213;

  const
    tidBlock_DissglassConstr = 'DissglassConstr';
    tidBlock_Dissglass       = 'Dissglass';
    tidFacility_Dissglass    = 'Dissglass';
    vidFacility_Dissglass    = 10307;
  const
    tidBlock_DissconveybsysConstr = 'DissconveybsysConstr';
    tidBlock_Dissconveybsys       = 'Dissconveybsys';
    tidFacility_Dissconveybsys    = 'Dissconveybsys';
    vidFacility_Dissconveybsys    = 10304;
  const
    tidBlock_DissbuscompConstr = 'DissbuscompConstr';
    tidBlock_Dissbuscomp       = 'Dissbuscomp';
    tidFacility_Dissbuscomp    = 'Dissbuscomp';
    vidFacility_Dissbuscomp    = 10310;
