...
interface
  ...
  const
    //new buildings     buscomp
    // buscomp
    cost_buscomp = 33600001;
    budget_buscomp = 2708.2922;
    input_buscomp_Metal = 10;
    input_buscomp_Electroniccomponents = 30;
    input_buscomp_Chemicals = 10;
    input_buscomp_Plastics = 10;
    input_buscomp_ExecutivesWorkForce = 1;
    input_buscomp_ProfessionalWorkForce = 9;
    input_buscomp_Workers = 110;
    input_buscomp_ComputerServices = 1.20000004768372;
    input_buscomp_LegalServices = 0.240000009536743;

    output_buscomp_BusinessMachines = 16;
    // conveybsys Industry
    cost_conveybsys = 33600001;
    budget_conveybsys = 1425.2922;
    input_conveybsys_Metal = 720;
    input_conveybsys_Chemicals = 60;
    input_conveybsys_ElectronicComponents = 24;
    input_conveybsys_ExecutivesWorkForce = 1;
    input_conveybsys_ProfessionalWorkForce = 5;
    input_conveybsys_Workers = 131;
    input_conveybsys_ComputerServices = 0.240000009536743;
    input_conveybsys_LegalServices = 0.120000004768372;

    output_conveybsys_Machinery = 1.20000004768372;
    // Construction
    cost_glass = 35280001;
    budget_glass = 841.5068;
    input_glass_Ore = 144;
    input_glass_ExecutivesWorkForce = 0;
    input_glass_ProfessionalWorkForce = 4;
    input_glass_Workers = 164;
    input_glass_ComputerServices = 0.480000019073486;
    input_glass_LegalServices = 0.120000004768372;

    output_glass_Construction = 24;
    // Tvs small
    cost_Tvssmall = 7200000;
    budget_Tvssmall = 196.9042;
    input_Tvssmall_Metal = 10;
    input_Tvssmall_Electroniccomponents = 10;
    input_Tvssmall_Chemicals = 4;
    input_Tvssmall_Plastics = 5;
    input_Tvssmall_ExecutivesWorkForce = 1;
    input_Tvssmall_ProfessionalWorkForce = 3;
    input_Tvssmall_Workers = 76;
    input_Tvssmall_ComputerServices = 0.160000011324882;
    input_Tvssmall_LegalServices = 0.0800000056624413;

    output_Tvssmall_HouseHoldingAppliances = 4.80000019073486;
    // Tvs
    cost_Tvs = 30240001;
    budget_Tvs = 612.863;
    input_Tvs_Metal = 40;
    input_Tvs_Electroniccomponents = 30;
    input_Tvs_Chemicals = 11;
    input_Tvs_Plastics = 14;
    input_Tvs_ExecutivesWorkForce = 1;
    input_Tvs_ProfessionalWorkForce = 4;
    input_Tvs_Workers = 131;
    input_Tvs_ComputerServices = 0.480000019073486;
    input_Tvs_LegalServices = 0.240000009536743;

    output_Tvs_HouseHoldingAppliances = 14.4000005722046;
    // Smallcar
    cost_Smallcar = 33600001;
    budget_Smallcar = 672.2922;
    input_Smallcar_Metal = 180;
    input_Smallcar_FabricsandThreads = 22;
    input_Smallcar_Electroniccomponents = 10;
    input_Smallcar_Chemicals = 12;
    input_Smallcar_Plastics = 2;
    input_Smallcar_ExecutivesWorkForce = 5;
    input_Smallcar_ProfessionalWorkForce = 15;
    input_Smallcar_Workers = 464;
    input_Smallcar_ComputerServices = 1.20000004768372;
    input_Smallcar_LegalServices = 0.360000014305115;

    output_Smallcar_Nicecars = 0.360000014305115;
    // Memory Industry small
    cost_Memorysmall = 7200000;
    budget_Memorysmall = 0;
    input_Memorysmall_Chemicals = 5;
    input_Memorysmall_Metal = 8;
    input_Memorysmall_ExecutivesWorkForce = 0;
    input_Memorysmall_ProfessionalWorkForce = 3;
    input_Memorysmall_Workers = 50;
    input_Memorysmall_ComputerServices = 0.100000001490116;
    input_Memorysmall_LegalServices = 0.120000004768372;

    output_Memorysmall_Electroniccomponents = 10.4000005722046;
    // Electronic Industry
    cost_Memory = 30240001;
    budget_Memory = 0;
    input_Memory_Chemicals = 14;
    input_Memory_Metal = 24;
    input_Memory_ExecutivesWorkForce = 1;
    input_Memory_ProfessionalWorkForce = 7;
    input_Memory_Workers = 88;
    input_Memory_ComputerServices = 0.300000011920929;
    input_Memory_LegalServices = 0.360000014305115;

    output_Memory_Electroniccomponents = 31.2000007629395;
     // steel small
    cost_steelsmall = 8000000;
    budget_steelsmall = 2.3379;
    input_steelsmall_Ore = 96;
    input_steelsmall_Chemicals = 7;
    input_steelsmall_ExecutivesWorkForce = 0;
    input_steelsmall_ProfessionalWorkForce = 1;
    input_steelsmall_Workers = 70;
    input_steelsmall_ComputerServices = 0.0800000056624413;
    input_steelsmall_LegalServices = 0.0400000028312206;

    output_steelsmall_Metal = 48;
    // steel
    cost_steel = 33600001;
    budget_steel = 0;
    input_steel_Ore = 288;
    input_steel_Chemicals = 21;
    input_steel_ExecutivesWorkForce = 0;
    input_steel_ProfessionalWorkForce = 2;
    input_steel_Workers = 120;
    input_steel_ComputerServices = 0.200000002980232;
    input_steel_LegalServices = 0.119999997317791;

    output_steel_Metal = 144;
    // CoalMine2 small
    cost_CoalMine2small = 2000000;
    budget_CoalMine2small = -12.4155;
    input_CoalMine2small_Chemicals = 3;
    input_CoalMine2small_ExecutivesWorkForce = 0;
    input_CoalMine2small_ProfessionalWorkForce = 1;
    input_CoalMine2small_Workers = 63;
    input_CoalMine2small_ComputerServices = 0.120000004768372;
    input_CoalMine2small_LegalServices = 0.0400000028312206;

    output_CoalMine2small_Ore = 160;

    // CoalMine2
    cost_CoalMine2 = 8400000;
    budget_CoalMine2 = 0;
    input_CoalMine2_Chemicals = 10;
    input_CoalMine2_ExecutivesWorkForce = 0;
    input_CoalMine2_ProfessionalWorkForce = 1;
    input_CoalMine2_Workers = 110;
    input_CoalMine2_ComputerServices = 0.360000014305115;
    input_CoalMine2_LegalServices = 0.120000004768372;

    output_CoalMine2_Ore = 480.000030517578;
    // SiliconMine2 small
    cost_SiliconMine2small = 2000000;
    budget_SiliconMine2small = -12.4155;
    input_SiliconMine2small_Chemicals = 3;
    input_SiliconMine2small_ExecutivesWorkForce = 0;
    input_SiliconMine2small_ProfessionalWorkForce = 1;
    input_SiliconMine2small_Workers = 63;
    input_SiliconMine2small_ComputerServices = 0.120000004768372;
    input_SiliconMine2small_LegalServices = 0.0400000028312206;

    output_SiliconMine2small_Ore = 160;

    // SiliconMine2
    cost_SiliconMine2 = 8400000;
    budget_SiliconMine2 = 0;
    input_SiliconMine2_Chemicals = 10;
    input_SiliconMine2_ExecutivesWorkForce = 0;
    input_SiliconMine2_ProfessionalWorkForce = 1;
    input_SiliconMine2_Workers = 110;
    input_SiliconMine2_ComputerServices = 0.360000014305115;
    input_SiliconMine2_LegalServices = 0.120000004768372;

    output_SiliconMine2_Ore = 480.000030517578;
    // ironMine small
    cost_ironMinesmall = 2000000;
    budget_ironMinesmall = -12.4155;
    input_ironMinesmall_Chemicals = 3;
    input_ironMinesmall_ExecutivesWorkForce = 0;
    input_ironMinesmall_ProfessionalWorkForce = 1;
    input_ironMinesmall_Workers = 63;
    input_ironMinesmall_ComputerServices = 0.120000004768372;
    input_ironMinesmall_LegalServices = 0.0400000028312206;

    output_ironMinesmall_Ore = 160;

    // ironMine
    cost_ironMine = 8400000;
    budget_ironMine = 0;
    input_ironMine_Chemicals = 10;
    input_ironMine_ExecutivesWorkForce = 0;
    input_ironMine_ProfessionalWorkForce = 1;
    input_ironMine_Workers = 110;
    input_ironMine_ComputerServices = 0.360000014305115;
    input_ironMine_LegalServices = 0.120000004768372;

    output_ironMine_Ore = 480.000030517578;

    // organicwaste small
    cost_organicwastesmall = 8000000;
    budget_organicwastesmall = -12.4155;
    //input_organicwastesmall_Chemicals = 3;
    input_organicwastesmall_ExecutivesWorkForce = 1;
    input_organicwastesmall_ProfessionalWorkForce = 10;
    input_organicwastesmall_Workers = 250;
    input_organicwastesmall_ComputerServices = 0.120000004768372;
    input_organicwastesmall_LegalServices = 0.0400000028312206;

    output_organicwastesmall_Ore = 160;
    // organicwaste
    cost_organicwaste = 40000000;
    budget_organicwaste = 0;
    //input_organicwaste_Chemicals = 10;
    input_organicwaste_ExecutivesWorkForce = 2;
    input_organicwaste_ProfessionalWorkForce = 25;
    input_organicwaste_Workers = 750;
    input_organicwaste_ComputerServices = 0.360000014305115;
    input_organicwaste_LegalServices = 0.120000004768372;

    output_organicwaste_Ore = 750;

    // fert small
    cost_fertsmall = 12000000;
    budget_fertsmall = -12.4155;
    input_fertsmall_ore = 350;
    input_fertsmall_ExecutivesWorkForce = 1;
    input_fertsmall_ProfessionalWorkForce = 5;
    input_fertsmall_Workers = 50;
    input_fertsmall_ComputerServices = 0.120000004768372;
    input_fertsmall_LegalServices = 0.0400000028312206;
    output_fertsmall_Ore = 150;
    // fert
    cost_fert = 60000000;
    budget_fert = 0;
    input_fert_ore = 750;
    input_fert_ExecutivesWorkForce = 2;
    input_fert_ProfessionalWorkForce = 15;
    input_fert_Workers = 1000;
    input_fert_ComputerServices = 0.360000014305115;
    input_fert_LegalServices = 0.120000004768372;
    output_fert_Ore = 650;

    // grainFarma small
    cost_grainFarmasmall = 2000000;
    budget_grainFarmasmall = 31.1845;
    input_grainFarmasmall_ExecutivesWorkForce = 0;
    input_grainFarmasmall_ProfessionalWorkForce = 5;
    input_grainFarmasmall_Workers = 40;
    input_grainFarmasmall_Chemicals = 100;

    output_grainFarmasmall_FreshFood = 50;
    output_grainFarmasmall_OrganicMaterials = 50;

    // grainFarma
    cost_grainFarma = 8400000;
    budget_grainFarma = 95.8731;
    input_grainFarma_ExecutivesWorkForce = 1;
    input_grainFarma_ProfessionalWorkForce = 14;
    input_grainFarma_Workers = 105;
    input_grainFarma_Chemicals = 150;

    output_grainFarma_FreshFood = 350;
    output_grainFarma_OrganicMaterials = 175;

     // mill
    cost_mill = 25200001;
    budget_mill = 0;
    input_mill_FreshFood = 60;
    input_mill_Chemicals = 3;
    input_mill_ExecutivesWorkForce = 0;
    input_mill_ProfessionalWorkForce = 1;
    input_mill_Workers = 66;
    input_mill_ComputerServices = 0.240000009536743;
    input_mill_LegalServices = 0.120000004768372;

    output_mill_ProcessedFood = 90;

    // mill small
    cost_millsmall = 6000000;
    budget_millsmall = 13.7534;
    input_millsmall_FreshFood = 25;
    input_millsmall_Chemicals = 1;
    input_millsmall_ExecutivesWorkForce = 0;
    input_millsmall_ProfessionalWorkForce = 1;
    input_millsmall_Workers = 38;
    input_millsmall_ComputerServices = 0.0800000056624413;
    input_millsmall_LegalServices = 0.0400000028312206;

    output_millsmall_ProcessedFood = 30;

    // cotton small
    cost_cottonsmall = 2400000;
    budget_cottonsmall = 0;
    input_cottonsmall_OrganicMaterials = 5.19999980926514;
    input_cottonsmall_Chemicals = 2;
    input_cottonsmall_ExecutivesWorkForce = 0;
    input_cottonsmall_ProfessionalWorkForce = 1;
    input_cottonsmall_Workers = 50;
    input_cottonSmall_ComputerServices = 0;
    input_cottonSmall_LegalServices = 0;

    output_cottonsmall_FabricsandThreads = 20;

    // cotton
    cost_cotton = 10080000;
    budget_cotton = 7.2877;
    input_cotton_OrganicMaterials = 18;
    input_cotton_Chemicals = 6;
    input_cotton_ExecutivesWorkForce = 0;
    input_cotton_ProfessionalWorkForce = 2;
    input_cotton_Workers = 88;
    input_cotton_ComputerServices = 0.12;
    input_cotton_LegalServices = 0.1;

    output_cotton_FabricsandThreads = 60.0000038146973;

    // trouser small
    cost_trousersmall = 3200000;
    budget_trousersmall = 0.7352;
    input_trousersmall_FabricsandThreads = 20;
    input_trousersmall_OrganicMaterials = 3;
    input_trousersmall_Chemicals = 2;
    input_trousersmall_ExecutivesWorkForce = 0;
    input_trousersmall_ProfessionalWorkForce = 1;
    input_trousersmall_Workers = 51;
    input_trousersmall_ComputerServices = 0.160000011324882;
    input_trousersmall_LegalServices = 0.0800000056624413;

    output_trousersmall_Cheapclothing = 12;

    // trouser
    cost_trouser = 13440001;
    budget_trouser = 9.7169;
    input_trouser_FabricsandThreads = 60;
    input_trouser_OrganicMaterials = 10;
    input_trouser_Chemicals = 6;
    input_trouser_ExecutivesWorkForce = 0;
    input_trouser_ProfessionalWorkForce = 1;
    input_trouser_Workers = 88;
    input_trouser_ComputerServices = 0.480000019073486;
    input_trouser_LegalServices = 0.240000009536743;

    output_trouser_Cheapclothing = 36;
    ...
    // elFarm
    cost_elFarm = 28400000;
    budget_elFarm = 295.8731;
    input_elFarm_ExecutivesWorkForce = 1;
    input_elFarm_ProfessionalWorkForce = 3;
    input_elFarm_Workers = 66;
    input_elFarm_Chemicals = 1;

    output_elFarm_FreshFood = 160;
    output_elFarm_OrganicMaterials = 6;

     // MassiveFarm
    cost_MassiveFarm = 90000000;
    budget_MassiveFarm = 950;
    input_MassiveFarm_ExecutivesWorkForce = 2;
    input_MassiveFarm_ProfessionalWorkForce = 6;
    input_MassiveFarm_Workers = 110;
    input_MassiveFarm_Chemicals = 3;

    output_MassiveFarm_FreshFood = 180;
    output_MassiveFarm_OrganicMaterials = 20;
