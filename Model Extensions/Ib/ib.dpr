...
procedure RegisterModelExtension;             
  ...
  begin
    ...
    MisLean := TMetaServerMission.Create(classID, 'Bank Robbery', 'This is the typical bank robbery. The team will enter a bank during its business hours and collect all the money from the counters and the clients and the vault, if you choose so.', 'One-shot', TBankRobbery);
    ...
    CrimLean := TMetaCriminal.Create(classId, 'Steve McQueen', '1', 5, 35, CrimSkills, 'Male');
    ...
    CrimLean := TMetaCriminal.Create(classId, 'Joe Pena', '2', 1, 17, CrimSkills, 'Male');
    CrimLean.Register('Criminal');
    ...
    CrimLean := TMetaCriminal.Create(classId, 'Jane Linux', '3', 1, 21, CrimSkills, 'Female');
    CrimLean.Register('Criminal');
    ...
    CrimLean := TMetaCriminal.Create(classId, 'Kaiser Sose', '4', 4, 32, CrimSkills, 'Male');
    CrimLean.Register('Criminal');
    ...
    CrimLean := TMetaCriminal.Create(classId, 'Mata Hari', '5', 2, 25, CrimSkills, 'Female');
    CrimLean.Register('Criminal');
    ...
    CrimSkills.Values['Forgery'] := 'No';
    CrimSkills.Values['Stability'] := '70';
    CrimLean := TMetaCriminal.Create(classId, 'Steven Pidity', '6', 1, 16, CrimSkills, 'Male');
    CrimLean.Register('Criminal');
    ...
    CrimLean := TMetaCriminal.Create(classId, 'Billy The Kid', '7', 3, 19, CrimSkills, 'Male');
    CrimLean.Register('Criminal');
    ...
    CrimSkills.Values['Forgery'] := 'No';
    CrimSkills.Values['Stability'] := '80';
    CrimLean := TMetaCriminal.Create(classId, 'Hope Less', '8', 1, 35, CrimSkills, 'Female');
    CrimLean.Register('Criminal');
    ...
    CrimLean := TMetaCriminal.Create(classId, 'Crazy Joe', '9', 1, 21, CrimSkills, 'Male');
    CrimLean.Register('Criminal');
    ...
    CrimSkills.Values['Forgery'] := 'No';
    CrimSkills.Values['Stability'] := '40';
    CrimLean := TMetaCriminal.Create(classId, 'Stupid Bill', '10', 1, 22, CrimSkills, 'Male');
    CrimLean.Register('Criminal');
    ...
    CrimLean := TMetaCriminal.Create(classId, 'Idiot Ben', '11', 1, 23, CrimSkills, 'Male');
    CrimLean.Register('Criminal');
    ...
    CrimSkills.Values['Forgery'] := 'No';
    CrimSkills.Values['Stability'] := '40';
    CrimLean := TMetaCriminal.Create(classId, 'Homer Simpsons', '12', 1, 45, CrimSkills, 'Male');
    CrimLean.Register('Criminal');
...
begin
    ...
    logs.Log('IB','IB start');
    IllSystem := TIllegalSystem.Create;
    logs.Log('IB','ill system created');
    World.RegisterWorldExtension( IllSystem );
    logs.Log('IB','Register world extension');
    IllSystem.Start;
    logs.Log('IB','ill system start');

     logs.Log('IB','illsystem.create');
        illSystem.Criminals := TLockableCollection.Create(0, rkBelonguer);
        logs.Log('IB','fcrim');
        illSystem.Leaders := TLockableCollection.Create(0, rkBelonguer);
        logs.Log('IB','flead');
     ...
     //Load Names eeeeeeeekk, wasn't done
      //females
    logs.Log('loadcrimnames','starfemale');
     AssignFile(crimfiles, 'females.txt');
     reset(crimfiles);
     logs.Log('loadcrimnames','resetfile');
     x:=1;
     repeat
        readln(crimfiles,y);
        logs.Log('loadcrimnames',y);
        z:='f' + inttostr(x);
        logs.Log('loadcrimnames',z);
        IllSystem.FirstFNameList.Values[z] := y;
        x:= x + 1;
        logs.Log('loadcrimnames','');
     until Eof(crimfiles);
     CloseFile(crimfiles);
      //males
      logs.Log('loadcrimnames','startmale');
     AssignFile(crimfiles, 'males.txt');     // ExtractFilePath(paramstr(0)) + 'ib\
     reset(crimfiles);
     x:=1;
     repeat
        readln(crimfiles,y);
        z:='m' + inttostr(x);
        IllSystem.FirstMNameList.Values[z] := y;
        x:= x + 1;
     until Eof(crimfiles);
     CloseFile(crimfiles);                             //IllSystem.LastNameList.Values['1'] := 'Appleby';
     //lastnames
     AssignFile(crimfiles, 'lastname.txt');
     reset(crimfiles);
     x:=1;
     repeat
        readln(crimfiles,y);
        z:=inttostr(x);
        IllSystem.LastNameList.Values[z] := y;
        x:= x + 1;
     until Eof(crimfiles);
     CloseFile(crimfiles);
