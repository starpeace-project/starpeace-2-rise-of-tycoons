...
interface
  ...
  const
    ...
    const
    tidBlock_MarikoelFarmConstr = 'MarikoelFarmConstr';
    tidBlock_MarikoelFarm       = 'MarikoelFarm';
    tidFacility_MarikoelFarm    = 'MarikoelFarm';
    vidFacility_MarikoelFarm    = 30001;

   const
    tidBlock_MarikoMassiveFarmConstr = 'MarikoMassiveFarmConstr';
    tidBlock_MarikoMassiveFarm       = 'MarikoMassiveFarm';
    tidFacility_MarikoMassiveFarm    = 'MarikoMassiveFarm';
    vidFacility_MarikoMassiveFarm    = 30004;
  ...
  const
    tidBlock_MarikovegFarmaConstr = 'MarikovegFarmaConstr';
    tidBlock_MarikovegFarma       = 'MarikovegFarma';
    tidFacility_MarikovegFarma    = 'MarikovegFarma';
    vidFacility_MarikovegFarma    = 10075;

  const
    tidBlock_MarikoSmallvegFarmaConstr = 'MarikoSmallvegFarmaConstr';
    tidBlock_MarikoSmallvegFarma       = 'MarikoSmallvegFarma';
    tidFacility_MarikoSmallvegFarma    = 'MarikoSmallvegFarma';
    vidFacility_MarikoSmallvegFarma    = 10078;

  const
    tidBlock_MarikostewfactConstr = 'MarikostewfactConstr';
    tidBlock_Marikostewfact       = 'Marikostewfact';
    tidFacility_Marikostewfact    = 'Marikostewfact';
    vidFacility_Marikostewfact    = 10081;
  const
    tidBlock_MarikoSmallstewfactConstr = 'MarikoSmallstewfactConstr';
    tidBlock_MarikoSmallstewfact       = 'MarikoSmallstewfact';
    tidFacility_MarikoSmallstewfact    = 'MarikoSmallstewfact';
    vidFacility_MarikoSmallstewfact    = 10084;
 const
    tidBlock_MarikoorganicMineConstr = 'MarikoorganicMineConstr';
    tidBlock_MarikoorganicMine       = 'MarikoorganicMine';
    tidFacility_MarikoorganicMine    = 'MarikoorganicMine';
    vidFacility_MarikoorganicMine    = 10087;
  const
    tidBlock_MarikoSmallorganicMineConstr = 'MarikoSmallorganicMineConstr';
    tidBlock_MarikoSmallorganicMine       = 'MarikoSmallorganicMine';
    tidFacility_MarikoSmallorganicMine    = 'MarikoSmallorganicMine';
    vidFacility_MarikoSmallorganicMine    = 10090;
 const
    tidBlock_MarikopolymerConstr = 'MarikopolymerConstr';
    tidBlock_Marikopolymer       = 'Marikopolymer';
    tidFacility_Marikopolymer    = 'Marikopolymer';
    vidFacility_Marikopolymer    = 10093;
  const
    tidBlock_MarikoSmallpolymerConstr = 'MarikoSmallpolymerConstr';
    tidBlock_MarikoSmallpolymer       = 'MarikoSmallpolymer';
    tidFacility_MarikoSmallpolymer    = 'MarikoSmallpolymer';
    vidFacility_MarikoSmallpolymer    = 10096;   
  const
    tidBlock_MarikonylonConstr = 'MarikonylonConstr';
    tidBlock_Marikonylon       = 'Marikonylon';
    tidFacility_Marikonylon    = 'Marikonylon';
    vidFacility_Marikonylon    = 10099;
  const
    tidBlock_MarikoSmallnylonConstr = 'MarikoSmallnylonConstr';
    tidBlock_MarikoSmallnylon       = 'MarikoSmallnylon';
    tidFacility_MarikoSmallnylon    = 'MarikoSmallnylon';
    vidFacility_MarikoSmallnylon    = 10102;
  const
    tidBlock_MarikoshirtConstr = 'MarikoshirtConstr';
    tidBlock_Marikoshirt       = 'Marikoshirt';
    tidFacility_Marikoshirt    = 'Marikoshirt';
    vidFacility_Marikoshirt    = 10105;
  const
    tidBlock_MarikoSmallshirtConstr = 'MarikoSmallshirtConstr';
    tidBlock_MarikoSmallshirt       = 'MarikoSmallshirt';
    tidFacility_MarikoSmallshirt    = 'MarikoSmallshirt';
    vidFacility_MarikoSmallshirt    = 10108;
  const
    tidBlock_MarikoshirtShopConstr = 'MarikoshirtShopConstr';
    tidBlock_MarikoshirtShop       = 'MarikoshirtShop';
    tidFacility_MarikoshirtShop    = 'MarikoshirtShop';
    vidFacility_MarikoshirtShop    = 10111;
  const
    tidBlock_MarikostewShopConstr = 'MarikostewShopConstr';
    tidBlock_MarikostewShop       = 'MarikostewShop';
    tidFacility_MarikostewShop    = 'MarikostewShop';
    vidFacility_MarikostewShop    = 10114;
  const
    tidBlock_MarikoalmineConstr = 'MarikoalmineConstr';
    tidBlock_Marikoalmine       = 'Marikoalmine';
    tidFacility_Marikoalmine    = 'Marikoalmine';
    vidFacility_Marikoalmine    = 10251;
  const
    tidBlock_MarikoSmallalmineConstr = 'MarikoSmallalmineConstr';
    tidBlock_MarikoSmallalmine       = 'MarikoSmallalmine';
    tidFacility_MarikoSmallalmine    = 'MarikoSmallalmine';
    vidFacility_MarikoSmallalmine    = 10255;
  const
    tidBlock_MarikocryoliteConstr = 'MarikocryoliteConstr';
    tidBlock_Marikocryolite       = 'Marikocryolite';
    tidFacility_Marikocryolite    = 'Marikocryolite';
    vidFacility_Marikocryolite    = 10259;
  const
    tidBlock_MarikoSmallcryoliteConstr = 'MarikoSmallcryoliteConstr';
    tidBlock_MarikoSmallcryolite       = 'MarikoSmallcryolite';
    tidFacility_MarikoSmallcryolite    = 'MarikoSmallcryolite';
    vidFacility_MarikoSmallcryolite    = 10263;
  const
    tidBlock_MarikosilaneConstr = 'MarikosilaneConstr';
    tidBlock_Marikosilane       = 'Marikosilane';
    tidFacility_Marikosilane    = 'Marikosilane';
    vidFacility_Marikosilane    = 10267;
  const
    tidBlock_MarikoSmallsilaneConstr = 'MarikoSmallsilaneConstr';
    tidBlock_MarikoSmallsilane       = 'MarikoSmallsilane';
    tidFacility_MarikoSmallsilane    = 'MarikoSmallsilane';
    vidFacility_MarikoSmallsilane    = 10271;
  const
    tidBlock_MarikoalIndustryConstr = 'MarikoalIndustryConstr';
    tidBlock_MarikoalIndustry        = 'MarikoalIndustry';
    tidFacility_MarikoalIndustry     = 'MarikoalIndustry';
    vidFacility_MarikoalIndustry     = 10275;
  const
    tidBlock_MarikoSmallalIndustryConstr = 'MarikoSmallalIndustryConstr';   
    tidBlock_MarikoSmallalIndustry        = 'MarikoSmallalIndustry';
    tidFacility_MarikoSmallalIndustry     = 'MarikoSmallalIndustry';
    vidFacility_MarikoSmallalIndustry     = 10278;
  const
    tidBlock_MarikotftConstr = 'MarikotftConstr';
    tidBlock_Marikotft        = 'Marikotft';
    tidFacility_Marikotft     = 'Marikotft';
    vidFacility_Marikotft     = 12081;
  const
    tidBlock_MarikoSmalltftConstr = 'MarikoSmalltftConstr';
    tidBlock_MarikoSmalltft        = 'MarikoSmalltft';
    tidFacility_MarikoSmalltft     = 'MarikoSmalltft';
    vidFacility_MarikoSmalltft     = 12085;
  const
    tidBlock_MarikomotorbikeConstr = 'MarikomotorbikeConstr';
    tidBlock_Marikomotorbike        = 'Marikomotorbike';
    tidFacility_Marikomotorbike     = 'Marikomotorbike';
    vidFacility_Marikomotorbike     = 12070;
  const
    tidBlock_MarikomphoneConstr = 'MarikomphoneConstr';
    tidBlock_Marikomphone        = 'Marikomphone';
    tidFacility_Marikomphone     = 'Marikomphone';
    vidFacility_Marikomphone     = 12073;
  const
    tidBlock_MarikoSmallmphoneConstr = 'MarikoSmallmphoneConstr';
    tidBlock_MarikoSmallmphone        = 'MarikoSmallmphone';
    tidFacility_MarikoSmallmphone     = 'MarikoSmallmphone';
    vidFacility_MarikoSmallmphone     = 12076;
  const
    tidBlock_MarikomobileStoreConstr = 'MarikomobileStoreConstr';
    tidBlock_MarikomobileStore        = 'MarikomobileStore';
    tidFacility_MarikomobileStore     = 'MarikomobileStore';
    vidFacility_MarikomobileStore     = 12079;
  const
    tidBlock_MarikomotorbikestoreConstr = 'MarikomotorbikestoreConstr';
    tidBlock_Marikomotorbikestore        = 'Marikomotorbikestore';
    tidFacility_Marikomotorbikestore     = 'Marikomotorbikestore';
    vidFacility_Marikomotorbikestore     = 10282;
  const
    tidBlock_MarikoplasterboardConstr = 'MarikoplasterboardConstr';
    tidBlock_Marikoplasterboard        = 'Marikoplasterboard';
    tidFacility_Marikoplasterboard     = 'Marikoplasterboard';
    vidFacility_Marikoplasterboard     = 10325;
  const
    tidBlock_MarikoroboticsysConstr = 'MarikoroboticsysConstr';
    tidBlock_Marikoroboticsys        = 'Marikoroboticsys';
    tidFacility_Marikoroboticsys     = 'Marikoroboticsys';
    vidFacility_Marikoroboticsys     = 10322;
  const
    tidBlock_Marikobm2Constr = 'Marikobm2Constr';
    tidBlock_Marikobm2        = 'Marikobm2';
    tidFacility_Marikobm2     = 'Marikobm2';
    vidFacility_Marikobm2     = 10328;
