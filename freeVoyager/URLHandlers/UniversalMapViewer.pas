...
implementation
  ...
  procedure TUniversalMapView.Start;
    ...
    begin
      ...
      DSPort := ConfigHolder.ReadInteger( true, '', 'DSPort', 1111 )+21;
                  ...
                  then
                    begin
                      try
                        ...
                        key := 'Root/Areas/' + Area + '/freeWorlds';
                    ...
                    for i := 0 to pred(count) do
                      with WorldList.Items.Add do
                        begin
                          ...
                          j:= 4 * strtoint(Worlds.Values[tidWorldProp_IB + IntToStr(i)]);     //tidWorldProp_IB
            ...
            if ((SelItem<>nil) and (fWorlds.Values[tidWorldProp_Rules + IntToStr(SelItem.Index)]<>''))
              then
                begin
                  ...
                  RulesTicker.Caption := fWorlds.Values[tidWorldProp_Rulest + IntToStr(tmpItem.Index)];
