...
uses
  ...
  InputSearchHandler, Config,popup,topinfobar;
  ...
  procedure TVoyagerWin.FormShow(Sender: TObject);
    ...
    begin
      ...
      try
        ...
        topinfobar.tib.Parent:=Voyagerwin;
...
procedure TVoyagerWin.popuptimerTimer(Sender: TObject);
begin
popup.form1.Visible:=true;
popup.form1.BringToFront;
popup.Form1.popupc.Enabled:=true;
popup.Form1.pupupclose.Visible:=false;
popup.form1.WebBrowser1.Navigate('http://sp1.starpeace2.com/freepop.asp');
end;
