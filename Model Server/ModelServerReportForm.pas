          ...
          begin
            ...
            try
              ...
              try
                ...
                if Reg.OpenKey( WorldNamekey, true )
                  then
                    begin
                      ...
                      Reg.writeString( 'cscallbPort' , csCallbackPort.Text );
  ...
  procedure TModelServerReport.FormCreate(Sender: TObject);
    ...
    begin
      ...
      try
        ...
        if ParamStr(2) <> ''
          then
            ...
            begin
              ...
              if pos( uppercase('FIVEModelServer'), uppercase(aux) ) <> 0
                then
                  WorldNameS := ''
                else
                  begin
        ...
        WorldNamekey:= ModelServerKey + worldnames;
        Reg := TRegistry.Create;
        try
          Reg.RootKey := HKEY_LOCAL_MACHINE;
          if Reg.OpenKey( WorldNamekey, false )
            then
              begin
                ...
                try
                  ...
                  try
                    csCallbackPort.Text := Reg.ReadString( 'cscallbPort' );
