            ...
            if InitConnection
              then begin
                ...
                try
                  ...
                  cmd.CommandText := 'priv_InsertKey';
                  ...
                  cmd.Parameters.Append(parm0);  cmd.Parameters.Append(parm1);

                  cmd.Execute(rsm, cmd.Parameters, 0 );
        ...
        if InitConnection
          then
            begin
              ...
              try
                cmd.Set_ActiveConnection(conn);
                cmd.CommandText := 'proc_keyCounts';
                cmd.CommandType := adCmdStoredProc;
                ...
                cmd.Parameters.Append(parm0);  cmd.Parameters.Append(parm1);
                cmd.Parameters.Append(parm2);  cmd.Parameters.Append(parm3);
        ...
        if InitConnection
          then
            begin
              ...
              try
                cmd.Set_ActiveConnection(conn);
                cmd.CommandText := 'proc_ValuesCounts';
                cmd.CommandType := adCmdStoredProc;
          ...
          then
            begin
              ...
              try
                ...
                cmd.Parameters.Append(parm0);  cmd.Parameters.Append(parm1);  cmd.Parameters.Append(parm2);

                rs := cmd.Execute(rsm, cmd.Parameters, 0);
                while not rs.EOF do
                  begin
                    fList.Add(rs.Fields.Item[0].Value);
                    rs.MoveNext;
                  end;
            ...
            if InitConnection
              then begin
                ...
                try
                  ...
                  parm4 := cmd.CreateParameter( '@value'      , adVarChar, adParamInput      ,  500, aValue        );
                  parm5 := cmd.CreateParameter( '@is_secured' , adBoolean, adParamInput      ,    1, fDirSecurity  );

                  cmd.Parameters.Append(parm0);   cmd.Parameters.Append(parm1);   cmd.Parameters.Append(parm2);
                  cmd.Parameters.Append(parm3);   cmd.Parameters.Append(parm4);   cmd.Parameters.Append(parm5);
          ...
          then
            begin
              ...
              try
                ...
                parm4 := cmd.CreateParameter( '@value'      , adVarChar, adParamOutput     ,  500, result        );

                cmd.Parameters.Append(parm0);  cmd.Parameters.Append(parm1); cmd.Parameters.Append(parm2);
                cmd.Parameters.Append(parm3);  cmd.Parameters.Append(parm4);
            ...
            if InitConnection
              then begin
                ...
                try
                  ...
                  parm4 := cmd.CreateParameter( '@is_secured' , adBoolean    , adParamInput      ,    1, fDirSecurity      );
              ...
              try
                ...
                if value_name <> ''
                  then begin
                    ...
                    parm1 := cmd.CreateParameter( '@key_path'   , adVarChar, adParamInput      , 1024, full_path  );
                    parm2 := cmd.CreateParameter( '@value_name' , adVarChar, adParamInput      ,  128, value_name );
                    parm3 := cmd.CreateParameter( '@kind_of'    , adTinyInt, adParamOutput     ,  500, result     );
      ...
      try
        ...
        if InitConnection
          then begin
            ...
            try
              cmd.Set_ActiveConnection(conn);
              cmd.CommandText := 'proc_IsSecurityKey';
              cmd.CommandType := adCmdStoredProc;
