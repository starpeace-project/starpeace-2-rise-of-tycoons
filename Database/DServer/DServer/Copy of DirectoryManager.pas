    ...
    TDirectoryManager =
      class
        public
          ...
          procedure SetSecurityLevel( secLevel : boolean );
...
// TDirectoryManager
  ...
  procedure TDirectoryManager.SetSecurityLevel( secLevel : boolean );
    begin
      fSecLevel := secLevel;
    end;
                    ...
                    begin
                      ...
                      if fields.Strings[1] = '7'  // Kind
                        then
                              ...
                              then begin
                                ...
                                if id <> ''
                                  then begin
                                    ...
                                    query.Clear;
                                    query.Add('INSERT INTO tbl_Values ( id, parent_key_id, Name, Kind, Value, is_Secured ) ');
                                    query.Add('VALUES(' + '''' + UID + '''' + ',' + '''' + id + '''' + ','      );
                                    query.Add('''' + Name + '''' + ',' + IntToStr(aType) + ',' + '''' + Value + '''' + ',' + IntToStr(Ord(fSecLevel)) + ')' );
                          ...
                          begin
                            query.Add('UPDATE tbl_Values');
                            query.Add('SET value = ' + '''' + Value + '''' + ',' + ' Kind = ' + IntToStr(aType) + ',' + 'is_Secured = ' +  IntToStr(Ord(fSecLevel)) );
                            query.Add('WHERE id = ' + '''' + id + '''');
              ...
              try
                ...
                if fields.Count > 0
                  then
                    begin
                      query.Clear;
                      query.Add('exec sp_dboption ' + '''' + fDBName + '''' + ',' + '''' +  'select into/bulkcopy' + '''' + ',' + '''' + 'true' + '''' );
                      ...
                      if bool
                        then
                          begin
                            ...
                            query.Clear;
                            query.Add('exec sp_dboption ' + '''' + fDBName + '''' + ',' + '''' +  'select into/bulkcopy' + '''' + ',' + '''' + 'false' + '''' );
                            bool := qModifyFields( query.Text );
                          end
                        else result := '';
                    end
                            ...
                            if result
                              then
                                begin
                                  ...
                                  query.Add('WHERE id = ' + '''' + vID + '''' + ',' + 'is_Secured = ' + IntToStr(Ord(fSecLevel)) );
                                  result := qModifyFields(query.Text);
                                end;
                          ...
                          begin
                            ...
                            if bool
                              then
                                begin
                                  query.Clear;
                                  query.Add('INSERT INTO tbl_Values ( id, parent_key_id, Name, Kind, Value, bigText, size, is_Secured )'                );
                                  query.Add('VALUES(' + '''' + UID + '''' + ',' + '''' + kID + '''' + ',' + '''' + Name + '''' + ','                    );
                                  query.Add( '7' + ',' + '''' + '' + '''' + ',' + '''' + '' + '''' + ',' + vSize + ',' + IntToStr(Ord(fSecLevel)) + ')' );
                                  result := qModifyFields( query.Text );
                ...
                if SearchPattern = ''
                  then
                    begin
                      ...
                      query.Add('and ( ' + queryKeysName + ' ) and v.isSecured = 0 and p.key_id = v.parent_key_id and ( ' + queryValuesName + ')' );
                    end
                  else
                    begin
                      query.Add('WHERE full_path LIKE ' + '''' + FullKeyName + '/'  + queryFormat(SearchPattern) + '''' );
                      query.Add('and p.key_id = v.parent_key_id and v.isSecured = 0 and ( ' + queryValuesName + ')' );
                    end;
