...
implementation
  ...
  function CalcOverLegenParam(Level : integer) : TOverLegendParam;
    ...
    begin
      ...
      Result.OverLegendFacLimit :=  strtoint(TheGlobalConfigHandler.GetConfigParm('Legend.facLimit', '501')) + (level-5)*strtoint(TheGlobalConfigHandler.GetConfigParm('abLegend.facLimit', '50'));
      {if TheGlobalConfigHandler.GetConfigParm('Legend.facLimit', '0') <> '501'
        then
          begin
            tot := 0;
