...
interface
  ...
  uses
    Types, TypInfo, Windows, Collection, Classes, MetaInstances, Plotter, Land, ClassStorageInt, CacheAgent,
    ...
    Tasks, Tutorial, TycoonVotes, Favorites, CloneOptions, Logs;
  ...
  type
    ...
    IRoadHandler =
      interface
        ...
        function  AreasAreConnected( CircuitId : TCircuitId; a,b,c,d, a1,b1,c1,d1 : integer ) : boolean;
    ...
    IModelFactory =
      interface
        ...
        //CTycoon changed to TTycoon
        function  NewTycoonRole( RoleId, name : string; TycoonClass : TTycoon; InitialBudget : TMoney ) : TTycoon;
