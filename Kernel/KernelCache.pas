        ...
        with TTycoon(Obj) do
          begin
            ...
            try
              ...
              result.WriteBoolean('tton', tton);
              result.WriteInteger('IB',kernel.ibison);
              try
                result.WriteInteger( 'tteam', tournteam );
                result.WriteString( 'tournteam', ttname );
              except                                   // tworld.towns[tournteam]
              end;
              if TournamentOn
                then
                  begin
      ...
      with TInhabitedTown(Obj) do
        begin
          ...
          try
            ...
            result.WriteInteger( 'townteam', id );
            result.WriteString('Name', Name);
