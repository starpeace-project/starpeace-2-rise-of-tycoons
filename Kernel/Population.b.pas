...
interface
  ...
  const   
    ...
    OfficesPerInhabitant    = 0.1;            // Offices generated by one inhabitant
    ...
    MaxMovers               = 50;              // Maximum number of people that can move to town in an hour
    MinimalPop              = 9000;
    ...
    OutWorkWeight         : array[TPeopleKind] of integer = (30, 25, 20);
    OutResidentialsWeight : array[TPeopleKind] of integer = (50, 50, 50);
    OutQOLWeight          : array[TPeopleKind] of integer = (80, 80, 80);
    OutUnemploymentWeight : array[TPeopleKind] of integer = (70, 50, 25);
  ...
  const
    EmigrationProb : array[TPeopleKind] of single  = (0.8, 0.38, 0.18);
    WorkersPercent : array[TPeopleKind] of integer = (30, 30, 40);
    FloatDisp      : array[TPeopleKind] of single  = (0.01, 0.02, 0.05);
