...
implementation
 ...
 procedure TTestMasterUrlHandler.setMasterURLHandler(const URLHandler : IMasterURLHandler);
   begin
    end;

  function TTestMasterUrlHandler.RegisterMetaHandler(const aMetaURLHandler : IMetaURLHandler) : TMetaHandlerRegistrationResult;
    begin
  ...
  procedure TTestMasterUrlHandler.ReportNavigation( const Handler : IURLHandler; URL : TURL; localBack, localForward : boolean );
    begin
    end;
