      ...
      class(TGameControl, IMetaURLHandler, IURLHandler, IShutDownTarget)
        ...
        public
          ...
          function DeleteBuildingsInArea(imin, jmin, imax, jmax : integer) : boolean;
                             ...
                             //  [Error] MapControl.pas(137): Declaration of 'setMasterURLHandler' differs from declaration in interface 'IURLHandler'
  const
...
implementation
 ...
 procedure TMapControl.setMasterURLHandler(const URLHandler : IMasterURLHandler);
   begin
   end;
