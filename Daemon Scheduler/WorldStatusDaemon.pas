...
interface
  ...
  uses
    DirServerSession, Daemons,variants;
...
procedure TVoidThread.Execute;
          ...
          then
            with fSMTP do
              begin
                ...
                DocInput.Headers.Add('Subject', 'World Status - World Down');
  ...
  procedure TWorldStatusDaemon.ReadConfiguration(IniFile : TIniFile);
    ...
    begin
      ...
      fSMTPServerAddress := IniFile.ReadString('General', 'SMTPServer', '');
      ...
      reportaddrs := IniFile.ReadString('General', 'ReportAddresses', 'support@starpeace2.com');
      if reportaddrs <> ''
        then
          begin
